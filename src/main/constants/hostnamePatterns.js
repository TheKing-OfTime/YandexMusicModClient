...
exports.applicationHostnamePattern = new RegExp(
  `^${config_js_1.config.appHostname}$`,
);
...
exports.passportYandexHostnamePattern = new RegExp(
  `^passport.yandex.(\\w{2,3})$`,
);
exports.ssoPassportYandexHostnamePattern = new RegExp(
