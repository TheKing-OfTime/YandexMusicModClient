...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6356],
  {
    96622: function (e, t, r) {
      r.r(t),
        r.d(t, {
          ExplicitMark: function () {
            return f;
          },
          ExplicitMarkVariant: function () {
            return d;
          },
          __esModule: function () {
            return p;
        ...
        l = {
          ...
          6161: (e, t, r) => {
            ...
            function c(e, t, r) {
              ...
              t))
                o.call(t, n) && !s.hasOwnProperty(n) && (i[n] = t[n]);
              if (e && e.defaultProps)
          ...
          7897: (e, t, r) => {
            ...
            t.ExplicitMark = (e) => {
              let {
                  className: t,
                  variant: r = a.ExplicitMarkVariant.E,
                  iconSize: o = "xxxs",
                } = e,
                l = r === a.ExplicitMarkVariant.E ? "explicit" : "adult";
              return (0, n.jsx)(i.Icon, { variant: l, className: t, size: o });
            };
          },
          5129: (e, t) => {
            var r, n;
            Object.defineProperty(t, "__esModule", { value: !0 }),
              (t.ExplicitMarkVariant = void 0),
              ((n = r || (t.ExplicitMarkVariant = r = {})).E = "e"),
              (n.NUMERIC = "18+");
          },
          5189: function (e, t, r) {
            var n =
            ...
            (t.IconComponent = (e) => {
              let {
                ...
                p = l.iconsCollection[i];
              return (0, a.jsx)(p, {
                className: (0, o.clsx)(
                  c.default.root,
                  r,
                  c.default["root_size_".concat(u)],
                ),
                focusable: n,
                "aria-label": t,
                ...d,
                "aria-hidden": !t,
                ref: f,
                style: { ...(d.style || {}), padding: s.paddings[i] },
              });
            }),
          ...
          5151: function (e, t, r) {
            ...
            t.iconsCollection = {
              ...
              donation: V.default,
              explicit: H.default,
              eye_crossed: M.default,
              filter: L.default,
              fullscreen: P.default,
              history: C.default,
              home_selected: S.default,
              home: T.default,
              info: I.default,
              kids: N.default,
              kinopoiskEn: D.default,
              kinopoiskRu: A.default,
              lightning: U.default,
              like: B.default,
              liked: F.default,
              likedVariant: z.default,
              ...
              more: q.default,
              musicLogo: Y.default,
              musicLogoCenterEn: J.default,
              musicLogoCenterRu: Q.default,
              ...
              playVibe: eg.default,
              plus: ev.default,
              plusBadge: ey.default,
              plusOutlined: ek.default,
              podcasts: eE.default,
              previous: e_.default,
              repeat_one: eb.default,
              repeat: eO.default,
              reset: ew.default,
              search: eR.default,
              search_selected: eh.default,
              settings: ej.default,
              share: eV.default,
              shuffle: eH.default,
              speed_1x: eM.default,
              speed_1_25x: eL.default,
              speed_1_5x: eP.default,
              speed_1_75x: eI.default,
              speed_2x: eC.default,
              syncLyrics: eS.default,
              trailer: eT.default,
              unavailable: eN.default,
              unpin: eD.default,
              users: eA.default,
              vibe: eU.default,
              volume: eB.default,
              volumeOff: eF.default,
              yandexPlusEn: ez.default,
              yandexPlusRu: eW.default,
            };
          },
          7066: (e, t, r) => {
            Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      Object.defineProperty(u, "__esModule", { value: !0 }),
        (u.ExplicitMarkVariant = u.ExplicitMark = void 0),
        (n = c(7897)),
        Object.defineProperty(u, "ExplicitMark", {
          enumerable: !0,
          get: function () {
            return n.ExplicitMark;
          },
        }),
        (a = c(5129)),
        Object.defineProperty(u, "ExplicitMarkVariant", {
          enumerable: !0,
          get: function () {
            return a.ExplicitMarkVariant;
          },
        });
      var f = u.ExplicitMark,
        d = u.ExplicitMarkVariant,
        p = u.__esModule;
    },
    34065: function (e, t, r) {
      r.d(t, {
        Z: function () {
          return u;
        },
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
              ...
              (t.createRipple = function (e, t, r) {
                ...
                (a.style.width = "".concat(i, "px")),
                  ...
                  (a.style.top = "".concat(c - o, "px")),
                  a.classList.add(t);
                let u = n.getElementsByClassName(t)[0];
                u && u.remove(), n.insertBefore(a, n.firstChild);
              });
          },
          8216: (e, t, r) => {
            Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            let a = r(9541),
              ...
              c = (e) => {
                let {
                  ...
                  j = (0, i.useId)(),
                  V = !i.Children.toArray(c).filter(Boolean).length,
                  H = "left" === n,
                  M = null;
                if (p) {
                  var L, P;
                  M = (0, i.cloneElement)(p, {
                    className: (0, o.clsx)(
                      s.default.icon,
                      {
                        [s.default["icon_position_".concat(n)]]: n && !V,
                        [s.default.icon_withButtonSize]: !(null ===
                          (L = p.props) || void 0 === L
                          ? void 0
                          : L.size),
                      },
                      null === (P = p.props) || void 0 === P
                        ? void 0
                        : P.className,
                      w,
                    ),
                ...
                return (0, a.jsx)("button", {
                  ...
                  className: (0, o.clsx)(
                    s.default.root,
                    s.default["root_".concat(f, "_").concat(k)],
                    s.default["root_radius_".concat(g)],
                    s.default.root_size,
                    {
                      [s.default["root_".concat(f, "_withHover_").concat(k)]]:
                        _ && !O,
                      [s.default["root_size_".concat(v)]]: v,
                      [s.default.root_withoutBorder]: !b,
                      [s.default.block]: r,
                      [s.default.flexIcon]: d,
                      [s.default.iconOnly]: V,
                      [s.default.root_icon_left]: p && !V && H,
                      [s.default.root_icon_right]: p && !V && !H,
                    },
                    u,
                  ),
                  type: y,
                  ...
                  children: p
                    ? (0, a.jsxs)("span", {
                        className: (0, o.clsx)(
                          ...
                          { [s.default.iconContainer_block]: r },
                          R,
                        ),
                        children: [H && M, !V && c, !H && M],
                      })
                    : c,
                });
              };
          ...
          7459: function (e, t, r) {
            ...
            let a = r(9541),
              ...
              c = (e) => {
                let { isChecked: t } = e;
                return (0, a.jsx)("div", {
                  className: (0, i.clsx)(s.default.icon, {
            ...
            t.Toggle = (e) => {
              ...
              return (
                ...
                (0, a.jsx)(l.Button, {
                  className: (0, i.clsx)(
                    s.default.root,
                    { [s.default.root_checked]: p },
                    t,
                  ),
                  radius: "xxxl",
                  variant: "default",
                  icon: (0, a.jsx)(c, { isChecked: p }),
                  withRipple: !1,
                  onClick: m,
                  role: "switch",
                  "aria-checked": p,
    ...
    73490: function (e, t, r) {
      ...
      var n = r(42288);
      let a = n.V5.model("BaseModalModel", {
        isOpened: n.V5.optional(n.V5.boolean, !1),
      }).actions((e) => ({
        onOpenChange(t) {
          e.isOpened = t;
        },
    ...
    11565: function (e, t, r) {
      ...
      var n = r(42288);
      let a = n.V5.model("Cover", {
        uri: n.V5.maybe(n.V5.string),
        color: n.V5.maybe(n.V5.string),
        videoUrl: n.V5.maybe(n.V5.string),
      });
    },
    395: function (e, t, r) {
      r.d(t, {
      ...
      var n,
        ...
        i = r(42288),
        o = r(7049);
      let l = i.V5.model("Experiment", {
          group: i.V5.maybe(i.V5.string),
          value: i.V5.maybe(i.V5.frozen()),
        }),
        s = i.V5.model("Experiments", {
          loadingState: i.V5.enumeration(Object.values(o.G)),
          experiments: i.V5.optional(i.V5.map(l), {}),
        })
          .views((e) => ({
            getExperiment: (t) => e.experiments.get(t),
            checkExperiment(t, r) {
              let n = e.experiments.get(t);
              return (null == n ? void 0 : n.group) === r;
            },
          }))
          .actions((e) => ({
            getData: (0, i.ls)(function* () {
              let { accountResource: t, modelActionsLogger: r } = (0, i.dU)(e);
              if (e.loadingState !== o.G.PENDING)
                try {
                  e.loadingState = o.G.PENDING;
                  let r = yield t.experimentsDetails();
                  e.experiments.clear();
                  Object.entries(r).forEach((t) => {
                    let [r, n] = t;
                    e.experiments.set(r, n);
                  });
                  if (window.EXPERIMENT_OVERRIDES) {
                    Object.entries(window.EXPERIMENT_OVERRIDES).forEach((t) => {
                      let [r, n] = t;
                      e.experiments.set(r, {group: n});
                    });
                  }
                  e.loadingState = o.G.RESOLVE;
                } catch (t) {
                  r.error(t), (e.loadingState = o.G.REJECT);
                }
            }),
          }));
      var c = r(40193),
        u = r(34152);
      ((n = a || (a = {})).LIKED = "1"), (n.DISLIKED = "0");
      let f = i.V5.optional(i.V5.map(i.V5.enumeration(Object.values(a))), {}),
        d = i.V5.model("Library", {
          loadingState: i.V5.enumeration(Object.values(u.Gui)),
          tracks: f,
          albums: f,
          artists: f,
          playlists: f,
          ...
          .actions((e) => {
            let t = {
                ...
                if (t) {
                  for (let r in t)
                    if (Object.prototype.hasOwnProperty.call(t, r)) {
                      let n = t[r] === c.Vf.LIKED ? "1" : "0";
                      e.set(String(r), n);
                    }
                }
              },
              getData: (0, i.ls)(function* () {
                let { libraryResource: r, modelActionsLogger: n } = (0, i.dU)(
                  e,
                );
                if (e.loadingState !== u.Gui.PENDING)
                  try {
                    e.loadingState = u.Gui.PENDING;
                    let n = yield r.getAllIds({});
                    e.albums.clear(),
                      e.artists.clear(),
                      e.playlists.clear(),
                      e.tracks.clear(),
                      t.setRecords(e.tracks, n.defaultLibrary),
                      t.setRecords(e.albums, n.albums),
                      t.setRecords(e.artists, n.artists),
                      t.setRecords(e.playlists, n.playlists),
                      (e.loadingState = u.Gui.RESOLVE);
                  } catch (t) {
                    n.error(t), (e.loadingState = u.Gui.REJECT);
                  }
              }),
              toggleTrackLike: (0, i.ls)(function* (t) {
                let { usersResource: r, modelActionsLogger: n } = (0, i.dU)(e),
                  a = String(t.entityId),
                  o = e.tracks.get(a);
                try {
                  let n;
                  ...
                  return (
                    "1" === e.tracks.get(a)
                      ? (e.tracks.delete(a), (n = yield r.unlikeTrack(i)))
                      : (e.tracks.set(a, "1"), (n = yield r.likeTrack(i))),
                    n
                  );
                } catch (t) {
                  return (
                    o ? e.tracks.set(a, o) : e.tracks.delete(a),
                    n.error(t),
                    c.Bi.ERROR
                  );
                }
              }),
              toggleTrackDislike: (0, i.ls)(function* (t) {
                let { usersResource: r, modelActionsLogger: n } = (0, i.dU)(e),
                  a = String(t.entityId),
                  o = e.tracks.get(a);
                try {
                  ...
                  return (
                    "0" === e.tracks.get(a)
                      ? (e.tracks.delete(a), (n = yield r.undislikeTrack(i)))
                      : (e.tracks.set(a, "0"), (n = yield r.dislikeTrack(i))),
                    n
                  );
                } catch (t) {
                  return (
              ...
              toggleArtistLike: (0, i.ls)(function* (t) {
                let { usersResource: r, modelActionsLogger: n } = (0, i.dU)(e),
                  a = String(t.entityId),
                  o = e.artists.get(a);
                try {
                  ...
                  return (
                    "1" === e.artists.get(a)
                      ? (e.artists.delete(a), (n = yield r.unlikeArtist(t)))
                      : (e.artists.set(a, "1"), (n = yield r.likeArtist(t))),
                    n
                  );
                } catch (t) {
                  return (
                    o ? e.artists.set(a, o) : e.artists.delete(a),
                    n.error(t),
                    c.Bi.ERROR
                  );
                }
              }),
              toggleArtistDislike: (0, i.ls)(function* (t) {
                let { usersResource: r, modelActionsLogger: n } = (0, i.dU)(e),
                  a = String(t.entityId),
                  o = e.artists.get(a);
                try {
                  ...
                  return (
                    "0" === e.artists.get(a)
                      ? (e.artists.delete(a), (n = yield r.undislikeArtist(t)))
                      : (e.artists.set(a, "0"), (n = yield r.dislikeArtist(t))),
                    n
                  );
                } catch (t) {
                  return (
              ...
              toggleAlbumLike: (0, i.ls)(function* (t) {
                let { usersResource: r, modelActionsLogger: n } = (0, i.dU)(e),
                  a = String(t.entityId),
                  o = e.albums.get(a);
                try {
                  ...
                  return (
                    "1" === e.albums.get(a)
                      ? (e.albums.delete(a), (n = yield r.unlikeAlbum(t)))
                      : (e.albums.set(a, "1"), (n = yield r.likeAlbum(t))),
                    n
                  );
                } catch (t) {
                  return (
                    o ? e.albums.set(a, o) : e.albums.delete(a),
                    n.error(t),
                    c.Bi.ERROR
                  );
                }
              }),
              togglePlaylistLike: (0, i.ls)(function* (t) {
                let { usersResource: r, modelActionsLogger: n } = (0, i.dU)(e),
                  a = String(t.entityId),
                  o = e.playlists.get(a);
                try {
                  ...
                  return (
                    "1" === e.playlists.get(a)
                      ? (e.playlists.delete(a), (n = yield r.unlikePlaylist(t)))
                      : (e.playlists.set(a, "1"),
                        (n = yield r.likePlaylist(t))),
                    n
                  );
                } catch (t) {
                  return (
                    o ? e.playlists.set(a, o) : e.playlists.delete(a),
                    n.error(t),
                    c.Bi.ERROR
                  );
                }
        ...
        p = i.V5.model("LikesCount", {
          likesCount: i.V5.maybe(i.V5.number),
          pendingLikesCount: i.V5.optional(i.V5.number, 0),
        })
          .views((e) => ({
      ...
      var m = r(71613);
      let g = i.V5.model("Settings", {
          layout: i.V5.maybeNull(i.V5.enumeration(Object.keys(m.t))),
          platform: i.V5.maybe(i.V5.enumeration(Object.values(u.t4T))),
        })
          .views((e) => ({
        ...
        v = i.V5.model("Sort", {
          sortBy: i.V5.string,
          sortOrder: i.V5.enumeration(Object.values(c.As)),
        }),
        y = i.V5.model("CaseForms", {
          nominative: i.V5.optional(i.V5.string, ""),
          genitive: i.V5.optional(i.V5.string, ""),
          dative: i.V5.optional(i.V5.string, ""),
          accusative: i.V5.optional(i.V5.string, ""),
          instrumental: i.V5.optional(i.V5.string, ""),
          prepositional: i.V5.optional(i.V5.string, ""),
        });
      var k = r(73490);
      let E = i.V5.model("Location", {
        pathname: i.V5.optional(i.V5.string, ""),
        searchParams: i.V5.optional(i.V5.string, ""),
        host: i.V5.optional(i.V5.string, ""),
        tld: i.V5.optional(i.V5.string, ""),
        origin: i.V5.optional(i.V5.string, ""),
        href: i.V5.optional(i.V5.string, ""),
      }).actions((e) => ({
        setPathname(t) {
          e.pathname = t;
        },
      ...
      var _ = r(11565);
      let b = i.V5.model("ModalsModel", {
        disclaimerModal: k.K,
        releaseNotesModal: k.K,
        shortcutsModal: k.K,
        aboutAppModal: k.K,
        overviewModal: k.K,
        paywallModal: k.K,
      ...
      var O = r(96622);
      let w = i.V5.model("ExplicitModel", {
        contentWarning: i.V5.maybe(i.V5.enumeration(Object.values(c.F1))),
        trackType: i.V5.maybe(i.V5.enumeration(Object.values(c.Vc))),
        disclaimers: i.V5.maybe(i.V5.array(i.V5.string)),
      }).views((e) => ({
        get isExplicit() {
          return e.contentWarning === c.F1.EXPLICIT;
        },
        get explicitDisclaimer() {
          ...
          if (
            null === (t = e.disclaimers) || void 0 === t
              ? void 0
              : t.includes(c.em.EXPLICIT)
          )
            return O.ExplicitMarkVariant.E;
          if (
            null === (r = e.disclaimers) || void 0 === r
              ? void 0
              : r.includes(c.em.AGE_18)
          )
            return O.ExplicitMarkVariant.NUMERIC;
          return null;
        },
        get apiExplicitMark() {
          if (!this.isExplicit) return null;
          let e = this.explicitDisclaimer;
          if (!e && this.isExplicit) return O.ExplicitMarkVariant.E;
          return e;
        },
        get albumExplicitMark() {
          let { experiments: t } = (0, i.yj)(e);
          if (
            null == t
              ? void 0
              : t.checkExperiment(u.peG.WebNextNewExplicitApi, "on")
          )
            return this.apiExplicitMark;
          if (e.contentWarning === c.F1.EXPLICIT && e.disclaimers)
            return e.disclaimers[0] === c.F1.EXPLICIT
              ? O.ExplicitMarkVariant.E
              : O.ExplicitMarkVariant.NUMERIC;
          return null;
        },
        get trackExplicitMark() {
          let { experiments: t } = (0, i.yj)(e);
          if (t.checkExperiment(u.peG.WebNextNewExplicitApi, "on"))
            return this.apiExplicitMark;
          if (e.contentWarning === c.F1.EXPLICIT)
            return c.Vc.PODCAST === e.trackType
              ? O.ExplicitMarkVariant.NUMERIC
              : O.ExplicitMarkVariant.E;
          return null;
        },
      ...
      var R = r(42782);
      let h = i.V5.model("DomainTrailerEntity", {
          available: i.V5.boolean,
        }).views((e) => ({
          get canShow() {
            if (!(0, i.fh)(e)) return !1;
            let { experiments: t } = (0, i.yj)(e);
            return (
              t.checkExperiment(R.p.WebNextEntityTrailer, "on") &&
              t.checkExperiment(R.p.WebNextSwitchToStrmWithoutEncrypt, "on") &&
              e.available
            );
          },
        })),
        j = i.V5.model("TrackIdModel", {
          id: i.V5.union(i.V5.string, i.V5.number),
          albumId: i.V5.maybe(i.V5.number),
          timestamp: i.V5.maybe(i.V5.string),
        });
    },
    13281: function (e, t, r) {
      r.d(t, {
        d: function () {
          return i;
        },
    ...
    54194: function (e, t, r) {
      ...
      class i extends a.y {
        constructor(
          e = "Http Client error",
          { code: t = "E_HTTP_CLIENT", ...r } = {},
        ) {
          super(e, { code: t, ...r }),
            (0, n._)(this, "name", "HttpException"),
            Object.setPrototypeOf(this, i.prototype);
        }
      }
    },
    10542: function (e, t, r) {
      r.d(t, {
        ...
        ((n = a || (a = {}))[(n.NOT_FOUND = 404)] = "NOT_FOUND"),
