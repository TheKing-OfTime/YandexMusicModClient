    ...
    [5897],
    {
        ...
        2257: (t, e, r) => {
            ...
            class a {
                get delete() {
                    var t;
                    return null == (t = this.cursor.delete)
                        ? void 0
                        : t.bind(this.cursor);
                }
                get update() {
                    var t;
                    return null == (t = this.cursor.update)
                        ? void 0
                        : t.bind(this.cursor);
                }
                ...
                constructor(t) {
                    Object.defineProperty(this, "cursor", {
                        ...
                        (this.continuePrimaryKey =
                            t.continuePrimaryKey.bind(t));
                }
            }
            class n extends a {
                [Symbol.asyncIterator]() {
            ...
            class l {
                ...
                get put() {
                    var t;
                    return null == (t = this.objectStore.put)
                        ? void 0
                        : t.bind(this.objectStore);
                }
                get add() {
                    var t;
                    return null == (t = this.objectStore.add)
                        ? void 0
                        : t.bind(this.objectStore);
                }
                get clear() {
                    var t;
                    return null == (t = this.objectStore.clear)
                        ? void 0
                        : t.bind(this.objectStore);
                }
                get delete() {
                    var t;
                    return null == (t = this.objectStore.delete)
                        ? void 0
                        : t.bind(this.objectStore);
                }
                createIndex(t, e, r) {
                    return this.objectStore.createIndex
                        ? new o(this.objectStore.createIndex(t, e, r))
                        : null;
                }
                deleteIndex(t) {
            ...
            class d {
                ...
                transaction(t, e, r) {
                    return new h(this.database.transaction(t, e, r));
                }
            ...
            class y {
                openDB(t) {
                    ...
                    return g(this, void 0, void 0, function* () {
                        let s = yield (0, i.P2)(this.name, t, {
                            blocked: e,
                            blocking: r,
                            terminated: a,
                            upgrade: (t, e, r, i, a) => {
                                let s = new d(t);
                                null == n || n(s, e, r, new h(i), a);
                            },
                        });
                        return new d(s);
                    });
                ...
                deleteDB(t) {
                    let { onBlocked: e } = t;
                    return g(this, void 0, void 0, function* () {
                        yield (0, i.MR)(this.name, { blocked: e });
                    });
                }
                constructor(t) {
                    Object.defineProperty(this, "name", {
            ...
            class l extends n.X {
                ...
                async getBlock(t, e) {
                    if (!(null == t ? void 0 : t.source))
                        throw new c("Landing block source is not defined");
                    let r = t.type === a.t.CHART_TRACKS,
                        i = ((t, e, r) => {
                            let { uri: i, count: a, countWeb: n, ...o } = e,
                                c = t + i,
                                l = (0, s.P)(o);
                    ...
                    return (
                        await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                searchParams: (0, n.P)({
                                    childModEnabled:
                                        null == t ? void 0 : t.childModEnabled,
                                }),
                            }),
                        )
                    ).json();
        ...
        56053: (t, e, r) => {
            ...
            class n extends a.t {
                constructor(
                    t = "Internal error",
                    { code: e = "E_CONTAINER", ...r } = {},
                ) {
                    super(t, { code: e, ...r }),
                        (0, i._)(this, "name", "ContainerException"),
                ...
                constructor(t) {
                    super(
                        ...
                        (0, i._)(
                            this,
                            "name",
                            "AlreadyExistsContainerException",
                        ),
        ...
        85897: (t, e, r) => {
            ...
            let u = Symbol("CONTAINER_USER_CONFIG_TOKEN"),
                ...
                p = Symbol("CONTAINER_FILE_STORAGE_TOKEN"),
                m = Symbol("CONTAINER_TRACK_MANAGER_TOKEN"),
                w = Symbol("CONTAINER_USERS_TRACKS_MANAGER_TOKEN"),
                E = Symbol("CONTAINER_ARTIST_MANAGER_TOKEN"),
                f = Symbol("CONTAINER_TRACKS_CONTROLLER_TOKEN"),
                b = Symbol("CONTAINER_PLAYLISTS_CONTROLLER_TOKEN"),
                k = Symbol("CONTAINER_ARTISTS_CONTROLLER_TOKEN"),
                T = Symbol("CONTAINER_DOWNLOADER_TOKEN"),
            ...
            !(function (t) {
                (t.TRACK_META_RECEIVED = "track_meta_received"),
                    (t.TRACK_DECRYPT_KEY_RECEIVED =
                        "track_decrypt_key_received"),
                ...
                onArtistImageReceived(t, e) {
                    ...
                    null == (r = this.fileStorage) ||
                        r.writeFile(i, e).catch((t) => {
                            this.hooks.afterError.promise(
                                new _("Failed to write artist image", {
                                    cause: t,
                                    data: { path: i },
                                }),
                            );
            ...
            let P = {
                ...
                K = {
                    name: a.ARTISTS_TRACKS,
                    version: 1,
                    restrictions: { attemptsCount: 3 },
                },
                j = {
                    name: a.RESPONSE_CACHE,
                    version: 1,
                    restrictions: { attemptsCount: 3, count: 100 },
                };
            !(function (t) {
            ...
            class G {
                async get(t, e, r) {
                    ...
                    return (
                        (null ==
                        (i = this.repositoryContainer.responseCacheRepository)
                            ? void 0
                            : i.get(t, e, r)) || null
                    );
                }
                put(t) {
                    var e;
                    let { uid: r, requestId: i, priority: a, response: s } = t;
                    null ==
                        (e =
                            this.repositoryContainer.responseCacheRepository) ||
                        e.put({
                            uid: r,
                            requestId: i,
                            priority: null != a ? a : n.LOW,
                            response: s,
                        });
                }
                constructor(t) {
            ...
            class q {
                get shouldGetCache() {
                    return (
                        "number" == typeof this.variables.uid &&
                        this.variables.isOffline
                    );
                }
                getRequestId(t) {
                    return (0, O.createHash)("sha256")
                ...
                async get(t, e) {
                    if ("number" == typeof this.variables.uid)
                        try {
                            let r = await this.cacheManager.get(
                                this.variables.uid,
                                t,
                                e,
                            );
                ...
                async handleError(t, e, r) {
                    if (!(t instanceof D.GX) || W.includes(t.statusCode))
                        return this.get(e, r);
                    throw t;
                }
                constructor(t) {
                    (0, h._)(this, "cacheManager", void 0),
                        ...
                        (this.cacheManager = new G({
                            repositoryContainer: t.repositoryContainer,
                        })),
                        (this.variables = t.variables);
                }
            }
            var H = r(2913);
            let V = (t) => (e) => e.id !== t || (e.stop(), !1);
            class Y {
                get quality() {
                ...
                removeTask(t) {
                    this.removeTaskFromQueue(t),
                        this.removeTaskFromActiveDownloads(t);
                }
                startTask(t) {
                ...
                startNextDownload() {
                    ...
                    e > 0 &&
                        ...
                        this.queue
                            .splice(0, e)
                            .forEach(this.startTask.bind(this));
                }
                removeTaskFromQueue(t) {
                    this.queue = this.queue.filter(V(t));
                }
                    ...
                    e.afterError.tapPromise("LoggerPlugin", async (t) => {
                        ...
                        return (
                            (e =
                                t instanceof S.t
                                    ? t
                                    : new S.t("Error in Slam", {
                                          code: "E_SLAM",
                                          cause: t,
                                      })).cause instanceof Error &&
                                delete e.cause.stack,
            ...
            class Z {
                async getArtist(t) {
                    ...
                    let n = {
                        ...
                        s = A(t);
                    if (
                        await (null == (r = this.fileStorage)
                            ? void 0
                            : r.isFileExisting(s))
                    ) {
                        let t = await (null == (i = this.fileStorage)
                            ? void 0
                            : i.createFileURL(s));
            ...
            !(function (t) {
                (t.STATE_CHANGED = "STATE_CHANGED"),
                    (t.ENTITY_CHANGED = "ENTITY_CHANGED");
            })(o || (o = {}));
            class tt {
                get state() {
                ...
                set state(t) {
                    (this.loadingState = t),
                        this.events.emit(o.STATE_CHANGED, this.state);
                }
                setEntityState(t, e) {
                    (this.loadingState[t] = e),
                        this.events.emit(o.ENTITY_CHANGED, { id: t, state: e });
                }
                clear() {
                    this.state = {};
                }
                constructor() {
                    (0, h._)(this, "loadingState", {}),
                        (0, h._)(this, "events", new H.v());
                }
            }
            class te {
            ...
            class ts extends S.t {
                constructor(t, { code: e = "E_DOWNLOADER", ...r } = {}) {
                    super("".concat("[Downloader]", " ").concat(t), {
                        code: e,
                        ...r,
                    }),
            ...
            class to {
                ...
                async getImage(t, e) {
                    try {
                        let r = (0, ti.createAvatarUrl)(
                                t,
                                this.variables.coverSize,
                                !1,
                            ),
                        ...
                        this.hooks.afterError.promise(
                            new ts("Error when downloading image", {
                                cause: String(e),
                                data: { src: t },
                            }),
                        );
                ...
                async start() {
                    try {
                        ...
                        if (!e || !e.available)
                            return void this.handleDownloadError(
                        ...
                        let { downloadInfo: a } = await this.getFileInfo(
                            r,
                            this.quality,
                        );
                        if ("error" in a || a.transport !== tn.o.ENCRAW)
                            return void this.handleDownloadError(
                                "Erorr in download info or transport is not encraw",
                            );
                        this.events.emit(
                            i.TRACK_DECRYPT_KEY_RECEIVED,
                            r,
                            a.key,
                        );
                        let n = null,
                        ...
                        let l = async () => {
                            ...
                            let t = 0;
                            null === n || s + this.variables.chunkSize < n
                                ? (t = s + this.variables.chunkSize - 1)
                                : s + this.variables.chunkSize >= n && (t = n);
                            let {
                                contentLength: e,
                                data: r,
                                contentRange: a,
                        ...
                        await l(),
                            s === n
                                ? (this.events.emit(
                                      i.MEDIA_FILE_RECEIVED,
                                      this.id,
                                      new Blob(o),
                                  ),
                                  this.events.emit(
                                      i.TRACK_DOWNLOAD_FINISHED,
                                      this.id,
                                  ))
                                : this.events.emit(
                                      i.TRACK_DOWNLOAD_STOPPED,
                                      this.id,
                                  );
                    } catch (t) {
                ...
                handleDownloadError(t) {
                    this.hooks.afterError.promise(
                        new ts("Error when downloading track", {
                            cause: t,
                            data: { id: this.id },
                        }),
                    ),
            ...
            class td {
                        ...
                        ? Promise.all(
                              t.albums.map(async (e) => {
                                  ...
                                  return Promise.all([
                                      ...
                                      (i =
                                          this.repositoryContainer
                                              .albumsTracksRepository)
                                          ? void 0
                                          : i.put(String(t.id), String(n.id)),
                                  ]);
                              }),
                          )
                        : Promise.resolve();
                ...
                async getTrackAlbums(t, e) {
                    ...
                    if (e) {
                        let t = await (null ==
                        (r = this.repositoryContainer.albumsRepository)
                            ? void 0
                            : r.get(e));
                        t && a.push({ ...t, artists: [] });
                    } else {
                            ...
                            await Promise.all(
                                e.map(async (t) =>
                                    this.repositoryContainer.albumsRepository
                                        ? this.repositoryContainer.albumsRepository.get(
                                              t,
                                          )
                                        : null,
                                ),
                ...
                async saveTrack(t) {
                    var e;
                    this.store.tracks.setEntityState(String(t.id), {
                        loadingState: c.DOWNLOADING,
                    });
                    let r = (0, tr.A)(t);
                    return (
                        delete r.albums,
                        ...
                        Promise.all([
                            null ==
                            (e = this.repositoryContainer.tracksRepository)
                                ? void 0
                                : e.put(r),
                ...
                async getTrack(t) {
                    ...
                    return (
                        s.coverUri &&
                            (s.coverUri = await (null == (r = this.fileStorage)
                                ? void 0
                                : r.createFileURL(tc(t)))),
                        (s.albums = await this.getTrackAlbums(String(s.id), a)),
                ...
                async getAllIds() {
                    var t;
                    return null ==
                        (t = this.repositoryContainer.tracksRepository)
                        ? void 0
                        : t.getAllIds();
                }
                async putDecryptKey(t, e) {
                    var r;
                    await (null ==
                    (r = this.repositoryContainer.tracksRepository)
                        ? void 0
                        : r.putDecryptKey(t, e));
                }
                async putTrackAvailable(t, e) {
                    ...
                    (r = this.repositoryContainer.tracksRepository)
                        ? void 0
                        : r.putTrackAvailable(t, e));
                }
                async deleteTrack(t, e) {
                    var r, i, a;
                    if (
                        (this.changeState(t, { loadingState: c.REMOVING }),
                        await this.usersTracksManager.delete(
                            this.userConfig.uid,
                            t,
                        ),
                        0 !==
                            (await this.usersTracksManager.getCountByTrackId(
                                t,
                            )))
                    )
                        return void this.changeState(t, {
                            loadingState: c.DOWNLOADED,
                        });
                    await Promise.all([
                        ...
                        null == (i = this.repositoryContainer.fileStorage)
                            ? void 0
                            : i.deleteFile(tc(String((0, J.V)(t, e)))),
                ...
                download(t) {
                    ...
                    if (!r) return;
                    let i =
                        null == (e = this.store.tracks.state[r])
                            ? void 0
                            : e.loadingState;
                    (!this.store.tracks.state[r] || (i && th.includes(i))) &&
                        this.downloader.injectTask(
                            new to(
                                String(t),
                                this.trackDownloadTaskParams,
                                this.downloader.quality,
                            ),
                        );
                }
                stopDownload(t) {
                    ...
                    let i =
                        null == (e = this.store.tracks.state[r])
                            ? void 0
                            : e.loadingState;
                    (!this.store.tracks.state[r] || (i && tu.includes(i))) &&
                        (this.changeState(r, { loadingState: c.IDLE }),
                        this.downloader.removeTask(String(t)));
                }
                onTrackDownloadFinished(t) {
                    let [e, r] = (0, J.d)(t);
                    e &&
                        (this.usersTracksManager.put({
                            uid: this.userConfig.uid,
                            downloadSource: s.TRACK,
                            trackId: e,
                            albumId: r,
                        }),
                        this.changeState(e, { loadingState: c.DOWNLOADED }));
                }
                onTrackDownloadStopped(t) {
                    let [e, r] = (0, J.d)(t);
                    e &&
                        (this.deleteTrack(e, r),
                        this.changeState(e, { loadingState: c.IDLE }));
                }
                onTrackDownloadFailed(t) {
                    ...
                    e &&
                        (this.deleteTrack(e, r),
                        this.changeState(e, {
                            loadingState: c.DOWNLOAD_FAILED,
                        }));
                }
                ...
                onChunkMediaFileReceived(t, e) {
                    ...
                    let [i] = (0, J.d)(t);
                    i &&
                        (null == (r = this.store.tracks.state[i])
                            ? void 0
                            : r.loadingState) !== c.IDLE &&
                        this.changeState(i, {
                            loadingState: c.DOWNLOADING,
                            progress: e,
                        });
                ...
                onMediaFileReceived(t, e) {
                    ...
                    if (
                        !a ||
                        (null == (r = this.store.tracks.state[a])
                            ? void 0
                            : r.loadingState) === c.IDLE
                    )
                        return;
            ...
            class tv {
                    ...
                    try {
                        ...
                        (null == t ? void 0 : t.length) &&
                            (this.store.tracks.state = t.reduce((t, e) => {
                                ...
                                return (
                                    r &&
                                        (t[r] = { loadingState: c.DOWNLOADED }),
                                    t
                                );
                            }, {}));
                    } catch (t) {
                        this.hooks.afterError.promise(
                            new ty("Failed to init tracks state", { cause: t }),
                        );
                    }
                }
                async clearAll() {
                    try {
                        ...
                        this.hooks.afterError.promise(
                            new ty("Failed to clear all tracks", { cause: t }),
                        );
                    }
                }
                async validateTracks() {
                    try {
                        ...
                        this.hooks.afterError.promise(
                            new ty("Failed to validate tracks", { cause: t }),
                        );
                    }
                }
                download(t) {
                ...
                async getTracks(t) {
                    let e = t;
                    return (t ||
                        (e = await this.usersTracksManager.getTracksByUid(
                            this.userConfig.uid,
                        )),
                    e)
                        ? (
                ...
                async deleteTrack(t) {
                    try {
                        let [e, r] = (0, J.d)(t);
                        if (!e) return;
                        await this.trackManager.deleteTrack(e, r);
                    } catch (e) {
                        this.hooks.afterError.promise(
                            new ty("Failed to delete track", {
                                cause: e,
                                data: { id: t },
                            }),
                        );
                        ...
                        let e = async (t) => {
                                (
                                    ...
                                    let { trackId: e, available: r } = t,
                                        [i] = (0, J.d)(e);
                                    i &&
                                        this.trackManager.putTrackAvailable(
                                            i,
                                            r,
                                        );
                                });
                            ...
                            r = (0, tg.A)(
                                t,
                                this.variables.requestTrackChunkSize,
                            );
                        Promise.all(r.map(e));
                    } catch (t) {
                        this.hooks.afterError.promise(
                            new ty("Failed to refresh tracks availability", {
                                cause: t,
                            }),
                        );
                    }
                ...
                async refreshTracksMeta() {
                    try {
                        ...
                        let e = async (t) => {
                                (
                                    await this.tracksResource.getTracksMeta({
                                        trackIds: t,
                                    })
                        ...
                        this.hooks.afterError.promise(
                            new ty("Failed to refresh tracks meta", {
                                cause: t,
                            }),
                        );
                    }
                ...
                async updateTrackMeta(t) {
                    try {
                        var e, r;
                        let i = await this.usersTracksManager.get(
                            this.userConfig.uid,
                            String(t.id),
                        );
                        if (!i) return;
                        let a =
                            null == (r = t.albums) || null == (e = r[0])
                                ? void 0
                                : e.id;
                        if (
                            (void 0 === i.albumId && void 0 === a) ||
                            i.albumId === String(a)
                        ) {
                            await this.trackManager.deleteTrackArtists(
                                String(t.id),
                            ),
                        ...
                        await this.deleteTrack(
                            String((0, J.V)(i.trackId, i.albumId)),
                        ),
                            this.download(String((0, J.V)(t.id, a)));
                    } catch (e) {
                        this.hooks.afterError.promise(
                            new ty("Failed to update track meta", {
                                cause: e,
                                data: { id: t.id },
                            }),
                        );
                ...
                constructor(t) {
                    (0, h._)(this, "userConfig", void 0),
                        ...
                        (0, h._)(this, "usersTracksManager", void 0),
                        (0, h._)(this, "variables", void 0);
                    let { availabilityResource: e, tracksResource: r } =
                        t.container.get(y);
                    (this.userConfig = t.container.get(u)),
                        (this.hooks = t.container.get(C)),
                        (this.store = t.container.get(g)),
            ...
            class tE extends S.t {
                constructor(t, { code: e = "E_FILE_STORAGE", ...r } = {}) {
                    super("".concat("[FileStorage]", " ").concat(t), {
                        code: e,
                        ...r,
                    }),
            ...
            class tf {
                ...
                async deleteFile(t, e) {
                    try {
                        ...
                        throw this.generateError(
                            "Error when trying to delete file",
                            e,
                            { path: t },
                        );
                    }
            ...
            !(function (t) {
                (t.WRITE = "WRITE"),
                    (t.READ = "READ"),
                    (t.DELETE = "DELETE"),
                    (t.CREATE_URL = "CREATE_URL"),
                    (t.IS_EXISTING = "IS_EXISTING");
            })(l || (l = {}));
            class tb {
                async executeWithLock(t, e) {
                    ...
                    let i = e();
                    return (
                        this.operationsInProgress.set(t, i),
                        i.finally(() => {
                ...
                async writeFile() {
                    ...
                    return this.executeWithLock(
                        this.getOperationKey(l.WRITE, ...e),
                        async () => this.storage.writeFile(...e),
                    );
                }
                async readFile() {
                    for (
                        ...
                        e[r] = arguments[r];
                    return this.executeWithLock(
                        this.getOperationKey(l.READ, ...e),
                        async () => this.storage.readFile(...e),
                    );
                }
                async deleteFile() {
                    for (
                        ...
                        e[r] = arguments[r];
                    return this.executeWithLock(
                        this.getOperationKey(l.DELETE, ...e),
                        async () => this.storage.deleteFile(...e),
                    );
                }
                async createFileURL() {
                    for (
                        ...
                        e[r] = arguments[r];
                    return this.executeWithLock(
                        this.getOperationKey(l.CREATE_URL, ...e),
                        async () => this.storage.createFileURL(...e),
                    );
                }
                async isFileExisting() {
                    for (
                        ...
                        e[r] = arguments[r];
                    return this.executeWithLock(
                        this.getOperationKey(l.IS_EXISTING, ...e),
                        async () => this.storage.isFileExisting(...e),
                    );
                }
                ...
                constructor(t = new tf()) {
                    (0, h._)(this, "storage", void 0),
                        (0, h._)(this, "operationsInProgress", new Map()),
                        (this.storage = t);
                }
            }
            class tk extends S.t {
                constructor(t, { code: e = "E_IDB_REPOSITORY", ...r } = {}) {
                    super("".concat("[IndexedDB]", " ").concat(t), {
                        code: e,
                        ...r,
                    }),
            ...
            class tT {
                ...
                async executeTransaction(t) {
                    ...
                    if (!this.isIdbAvailable || !e)
                        throw this.generateError(
                            "IdbRepository is not available",
                        );
                    return t(e);
                }
                async count() {
                ...
                onError() {
                    this.closeConnection().finally(() => {
                        ...
                        this.config.restrictions.attemptsCount
                            ? (this.attemptsConnection++,
            ...
            class tC extends tT {
                async put(t) {
                    return this.executeTransaction(async (e) => {
                        var r;
                        let i = await e.get(P.name, String(t.id)),
                            a = Date.now(),
                            n =
                                null != (r = null == i ? void 0 : i.createdAt)
                                    ? r
                                    : a;
                        return e.put(
                            P.name,
                            { meta: t, updatedAt: a, createdAt: n },
                            String(t.id),
                        );
                    }).catch((e) => {
                        throw this.generateError(
                            "Error when trying to put data",
                            e,
                            { albumId: t.id },
                        );
                    });
                ...
                async get(t) {
                    return this.executeTransaction(async (e) => {
                        var r;
                        let i = await e.get(P.name, t);
                        return null != (r = null == i ? void 0 : i.meta)
                            ? r
                            : null;
                    }).catch((e) => {
                        throw this.generateError(
                ...
                async delete(t) {
                    return this.executeTransaction(async (e) =>
                        ...
                        throw this.generateError(
                            "Error when trying to delete data",
                            e,
                            { albumId: t },
                        );
                    });
            ...
            let tI = "albumId",
                tS = "trackId",
                t_ = (t, e) => "".concat(t, ":").concat(e);
            class tA extends tT {
                async put(t, e) {
                    return this.executeTransaction(async (r) =>
                        r.put(L.name, { trackId: t, albumId: e }, t_(t, e)),
                    ).catch((r) => {
                        throw this.generateError(
                            "Error when trying to put data",
                            r,
                ...
                async get(t, e) {
                    return this.executeTransaction(async (r) => {
                        let i = await r.get(L.name, t_(t, e));
                ...
                async getTracksByAlbumId(t) {
                    return this.executeTransaction(async (e) =>
                        (await e.getAllFromIndex(L.name, tI, t)).map(
                            (t) => t.trackId,
                        ),
                    ).catch((e) => {
                        throw this.generateError(
                ...
                async getAlbumsByTrackId(t) {
                    return this.executeTransaction(async (e) =>
                        (await e.getAllFromIndex(L.name, tS, t)).map(
                            (t) => t.albumId,
                        ),
                    ).catch((e) => {
                        throw this.generateError(
                    ...
                    super({
                        ...
                        handlers: {
                            onUpgrade: (t) => {
                                ...
                                e.createIndex(tI, "albumId"),
                                    e.createIndex(tS, "trackId");
                            },
                        },
                    });
                }
            ...
            class tR extends tT {
                async put(t) {
                    return this.executeTransaction(async (e) => {
                        var r;
                        let i = await e.get(F.name, String(t.id)),
                            a = Date.now(),
                            n =
                                null != (r = null == i ? void 0 : i.createdAt)
                                    ? r
            ...
            let tO = "artistId",
                tD = "trackId",
                tx = (t, e) => "".concat(t, ":").concat(e);
            class tN extends tT {
                async put(t) {
                    let { trackId: e, artistId: r } = t;
                    return this.executeTransaction(async (i) =>
                        i.put(K.name, t, tx(e, r)),
                    ).catch((t) => {
                        throw this.generateError(
                            "Error when trying to put data",
                            t,
                            { artistId: r, trackId: e },
                        );
                    });
                }
                async get(t, e) {
                    return this.executeTransaction(async (r) => {
                        let i = await r.get(K.name, tx(t, e));
                        return null != i ? i : null;
                    }).catch((r) => {
                        throw this.generateError(
                            "Error when trying to get data",
                            r,
                            { trackId: t, artistId: e },
                        );
                    });
                }
                async getArtistsByTrackId(t) {
                    return this.executeTransaction(async (e) =>
                        (await e.getAllFromIndex(K.name, tD, t)).sort(
                ...
                async getTracksByArtistId(t) {
                    return this.executeTransaction(async (e) =>
                        (await e.getAllFromIndex(K.name, tO, t)).sort(
                            (t, e) => t.artistIndex - e.artistIndex,
                        ),
                    ).catch((e) => {
                        throw this.generateError(
                ...
                async delete(t, e) {
                    return this.executeTransaction(async (r) =>
                        r.delete(K.name, tx(t, e)),
                    ).catch((r) => {
                        throw this.generateError(
                            "Error when trying to delete data",
                            r,
                            { artistId: e, trackId: t },
                        );
                    });
                }
                async getCountByArtist(t) {
                    return this.executeTransaction(async (e) =>
                        e.countFromIndex(K.name, tO, t),
                    ).catch((e) => {
                        throw this.generateError(
                            "Error when trying to get data",
                            e,
                    ...
                    super({
                        ...
                        handlers: {
                            onUpgrade: (t) => {
                                ...
                                e.createIndex(tD, "trackId"),
                                    e.createIndex(tO, "artistId");
                            },
                        },
                    });
                }
            }
            let tP = "priority_updatedAt",
                tL = (t, e) => "".concat(t, ":").concat(e);
            class tF extends tT {
                async put(t) {
                    ...
                    return this.executeTransaction(async (i) => {
                        ...
                        let n = await this.get(e, r),
                            s = Date.now(),
                            o =
                                null != (a = null == n ? void 0 : n.createdAt)
                                    ? a
                                    : s,
                        ...
                        return (
                            n ||
                                l < Number(j.restrictions.count) ||
                                (await this.deleteResponseByLowPriority()),
                            i.put(j.name, c, tL(e, r))
                        );
                    }).catch((t) => {
                        throw this.generateError(
                            "Error when trying to put data",
                ...
                constructor() {
                    super({
                        ...
                        handlers: {
                            onUpgrade: (t) => {
                                t.createObjectStore(j.name).createIndex(tP, [
                                    "priority",
                                    "updatedAt",
                                ]);
                            },
            ...
            class tK extends tT {
                async put(t) {
                    return this.executeTransaction(async (e) => {
                        ...
                        return e.put(
                            M.name,
                            { ...i, meta: t, updatedAt: a, createdAt: n },
                            t.id,
                        );
                    }).catch((e) => {
                        throw this.generateError(
                ...
                async putDecryptKey(t, e) {
                    return this.executeTransaction(async (r) => {
                        var i;
                        let a = await r.get(M.name, t);
                        if (!a) throw new tk("Track not found");
                        let n = Date.now(),
                            s =
                                null != (i = null == a ? void 0 : a.createdAt)
                                    ? i
                                    : n;
                        return r.put(
                            M.name,
            ...
            class tj extends tT {
                async put(t) {
                    return this.executeTransaction(async (e) => {
                        var r;
                        let i = await e.get(U.name, t.uid),
                            a = Date.now(),
                            n =
                                null != (r = null == i ? void 0 : i.createdAt)
                                    ? r
            ...
            class tB extends tT {
                async put(t) {
                    ...
                    return this.executeTransaction(async (i) => {
                        var a;
                        let n = tU(e, r),
                            s = await i.get(B.name, n),
                            o = Date.now(),
                            c =
                                null != (a = null == s ? void 0 : s.createdAt)
                                    ? a
                                    : o;
                        return i.put(
                            B.name,
                            { ...t, updatedAt: o, createdAt: c },
                            n,
                        );
                    }).catch((t) => {
                        throw this.generateError(
                ...
                async get(t, e) {
                    return this.executeTransaction(async (r) => {
                        let i = await r.get(B.name, tU(t, e));
                        return null != i ? i : null;
                    }).catch((r) => {
                        throw this.generateError(
                            "Error when trying to get data",
                ...
                async getTracksByUid(t) {
                    return this.executeTransaction(async (e) =>
                        (await e.getAllFromIndex(B.name, "uid", t))
                            .sort((t, e) => e.createdAt - t.createdAt)
                            .map((t) => {
                                let { trackId: e, albumId: r } = t;
                                return String((0, J.V)(e, r));
                            }),
                    ).catch((e) => {
                        throw this.generateError(
                            "Error when trying to get data",
                    ...
                    super({
                        ...
                        handlers: {
                            onUpgrade: (t) => {
                                ...
                                e.createIndex("uid", "uid"),
                                    e.createIndex(tM, "trackId");
                            },
                        },
                    });
                }
            ...
            class tG {
                ...
                get playlistsController() {
                    return this.container ? this.container.get(b) : null;
                }
                ...
                createCacheController(t) {
                    this.cacheController || (this.cacheController = new q(t));
                }
                init(t) {
                    var e, r;
                    this.container ||
                        (this.container = (function (t) {
                            let {
                                ...
                                userConfig: r,
                                resources: i,
                                downloaderVariables: a,
                                featureFlags: n,
                                tracksControllerVariables: s,
                                trackDownloadTaskParams: o,
                            } = t;
                            return new Q.Dt().registerMany({
                                [u]: (0, Q.Gr)(() => r),
                                [d]: (0, Q.Gr)(() => n),
                                [g]: (0, Q.Gr)(() => new te()),
                                [C]: (0, Q.Gr)(() => $),
                                [T]: (0, Q.Gr)(() => new Y({ variables: a })),
                                [y]: (0, Q.Gr)(() => i),
                                [v]: (0, Q.Gr)(() => e),
                                [p]: (0, Q.Gr)(() => e.fileStorage),
                                [m]: (0, Q.do)((t) => new td({ container: t })),
                                [w]: (0, Q.do)((t) => new tp({ container: t })),
                                [E]: (0, Q.do)((t) => new Z({ container: t })),
                                [f]: (0, Q.Gr)((t) => {
                                    let { entities: e } = t.get(d);
                                    return e
                                        ? new tv({ container: t, variables: s })
                                        : null;
                                }),
                                [b]: (0, Q.Gr)((t) => {
                                    let { entities: e } = t.get(d);
                                ...
                                [k]: (0, Q.Gr)((t) => {
                                    let { entities: e } = t.get(d);
                                    return e ? new R({ container: t }) : null;
                                }),
                                [I]: (0, Q.Gr)((t) => {
                                    let {
                                        tracksResource: e,
                        ...
                        null == (r = this.repositoryContainer) ||
                            null == (e = r.usersRepository) ||
                            e.put({ uid: t.userConfig.uid });
                }
                async clearAll() {
                    var t;
                    return Promise.all([
                        null == (t = this.tracksController)
                            ? void 0
                            : t.clearAll(),
                    ]);
                }
                    ...
                    (0, h._)(this, "hooks", $),
                        ...
                        (this.repositoryContainer = ((t) => {
                            let {
                                ...
                                a = {};
                            return (
                                e && (a.fileStorage = new tb()),
                                r && (a.responseCacheRepository = new tF()),
                                i &&
                                    ((a.albumsRepository = new tC()),
                                    (a.albumsTracksRepository = new tA()),
                                    (a.artistsRepository = new tR()),
                                    (a.artistsTracksRepository = new tN()),
                                    (a.tracksRepository = new tK()),
                                    (a.usersRepository = new tj()),
                                    (a.usersTracksRepository = new tB())),
                                a
                            );
                        })(t)),
                        null == e ||
                            e.forEach((t) => t.apply({ hooks: this.hooks }));
                }
            }
            var tW = r(25536);
            class tq extends tW.Q {
                async about(t, e) {
                    let r = this.cacheController.getRequestId({
                        resourceName: tW.Q.constructor.name,
                        ...
                        let a = t[e],
                            {
                                ...
                                var r, i, a, n;
                                let s =
                                    null == (r = t.overrides) ? void 0 : r[e];
                                return {
                                    enabled:
                                        null !=
                                        (i = null == s ? void 0 : s.enabled)
                                            ? i
                                            : t.enabled,
                                    ttl:
                                        null != (a = null == s ? void 0 : s.ttl)
                                            ? a
                                            : t.ttl,
                                    priority:
                                        null !=
                                        (n = null == s ? void 0 : s.priority)
                                            ? n
                                            : t.priority,
                                };
                            })(i, e);
                        return "function" == typeof a && n
                            ? async function () {
                                  for (
            ...
            class tY extends S.t {
                constructor(t, { code: e = "E_RESOURCE_PROXY", ...r } = {}) {
                    super("".concat("[ResourceProxy]", " ").concat(t), {
                        code: e,
                        ...r,
                    }),
            ...
            var tX = r(493);
            let tz = [tX.e.PREVIEW, tX.e.SMART_PREVIEW],
                tQ = async (t) => {
            ...
            class tJ extends tV.v {
                async isTrackDownloaded(t, e) {
                    if (!this.variables.uid || tz.includes(e)) return !1;
                    try {
                        ...
                        return (
                            this.hooks.afterError.promise(
                                new tY(
                                    "Can not determine if track was downloaded",
                                    { cause: e, data: { trackId: t } },
                                ),
                            ),
                            !1
                        );
                ...
                async getLocalFileDownloadInfo(t) {
                    let e = await this.tracksRepository.getDecryptKey(
                        String(t),
                    );
                    if (!e) throw new tY("Decrypt key not found");
                    let r = await this.fileStorage.readFile(tl(String(t))),
                        i = r.slice(0, r.size),
                        a = await i.arrayBuffer(),
                        n = await tQ({ data: a, key: e });
                    return {
                        trackId: t,
                        urls: [URL.createObjectURL(new Blob([n]))],
                    };
                }
                async getFileInfo(t, e) {
                    if (
                        !(await this.isTrackDownloaded(
                            String(t.trackId),
                            t.quality,
                        ))
                    )
                    ...
                    try {
                        ...
                        return (
                            this.hooks.afterError.promise(
                                new tY("Can not get a local file", {
                                    cause: r,
                ...
                async getSign(t, e, r, i) {
                    let a = (0, ta.T)(),
                        ...
                        o = ""
                            ...
                            .concat(i);
                    return (0, ta.m)({
                        secretKey: this.variables.secretKey,
                        data: o,
                    });
                }
                async getFileInfoBatch(t, e) {
                    ...
                    let o = await Promise.allSettled(
                            s.map(this.getLocalFileDownloadInfo.bind(this)),
                        ),
                        c = [];
                    o.forEach((t, e) => {
                        switch (t.status) {
                    ...
                    let l = null;
                    if (n.length > 0) {
                        let r = t.transports[0] || tn.o.RAW,
                            i = await this.getSign(n, t.codecs, t.quality, r);
                        try {
                            l = (
                                await super.getFileInfoBatch(
                                    { ...t, sign: i, trackIds: n.join(",") },
                                    e,
                                )
                            ).downloadInfos;
                        } catch (t) {
                            this.hooks.afterError.promise(
                                new tY("Can not get file info batch", {
                                    cause: String(t),
                                    data: { trackIds: n.join(",") },
                                }),
                            );
                        }
                    }
                ...
                constructor(t, e, r) {
                    ...
                    let {
                        fileStorage: i,
                        tracksRepository: a,
                        usersTracksRepository: n,
                        hooks: s,
                        variables: o,
                    } = r;
                    (this.fileStorage = i),
                        (this.tracksRepository = a),
                        (this.usersTracksRepository = n),
                        (this.hooks = s),
                        (this.variables = o);
                }
            }
                    ...
                    new Proxy(t, {
                        get(t, r) {
                            ...
                            return "function" == typeof i && a
                                ? function () {
                                      throw new D.GX("Offline mode enabled", {
                                          statusCode: tZ,
                                      });
                                  }
                                : i;
                ...
                async getCollectionDownloadedTracks() {
                    ...
                    try {
                        ...
                        return (
                            this.hooks.afterError.promise(
                                new tY(
                                    "Can not get collection downloaded tracks",
                                    { cause: e },
                                ),
                            ),
                            t
                ...
                async getSkeleton(t, e) {
                    ...
                    if (t.id === t6.p.WEB_COLLECTION) {
                        ...
                        try {
                            ...
                            return this.variables.cacheController.handleError(
                                t,
                                r,
                                6048e5,
                            );
            ...
            class s extends n.X {
                async getFileInfo(t, e) {
                    ...
                    return {
                        ...(await i.json()),
                        responseTime:
                            null == (r = i.timings) ? void 0 : r.response,
                        url: i.url,
                    };
                }
                async getFileInfoBatch(t, e) {
            ...
            class n extends a {
                createHttpOptions(t) {
                    let e =
                        ...
                        { prefixUrl: o, ...c } = s,
                        {
                            timeouts: l = this.config.timeouts,
                            withoutPrefixUrl: h,
                            withoutHeaders: u,
                        } = e,
                        d = null == l ? void 0 : l[r],
                ...
                createRequestHeaders() {
                    ...
                    let r =
                            arguments.length > 0 && void 0 !== arguments[0]
                                ? arguments[0]
                                : {},
                        { params: i, timeout: a } = r,
                        n = this.createRequestHeadersFromParams(i);
                    if (
                        (null !=
                        (e =
                            null == i || null == (t = i.common)
                                ? void 0
                                : t.sendRequestDeadline)
                            ? e
                            : this.config.params.common.sendRequestDeadline) &&
                        void 0 !== a
                    ) {
                        let t = Date.now() + a;
                    ...
                    let f =
                        ...
                        I =
                            ...
                            null == (s = o.blackbox)
                                ? void 0
                                : s.userTicket) ||
                            (null == (c = this.config.params.common.blackbox)
                                ? void 0
                                : c.userTicket),
                        S =
                            (null == t ||
                            ...
                            null == (l = h.tvm)
                                ? void 0
                                : l.serviceTicket) ||
                            (null == (u = this.config.params.common.tvm)
                                ? void 0
                                : u.serviceTicket),
                        _ =
                            null ==
                                (E =
                                    null == t || null == (d = t.common)
                                        ? void 0
                                        : d.withoutInvocationInfo) || E,
                        A =
                            (null == t || null == (g = t.common)
                                ? void 0
                                : g.icookie) ||
                            this.config.params.common.icookie,
                        R =
                            (null == t || null == (y = t.common)
                                ? void 0
                                : y.requestId) ||
                            this.config.params.common.requestId,
                        O =
                            (null == t || null == (v = t.common)
                                ? void 0
                                : v.clientIp) ||
                            this.config.params.common.clientIp,
                        D =
                            (null == t || null == (p = t.common)
                                ? void 0
                                : p.tracestate) ||
                            this.config.params.common.tracestate,
                        x =
                            (null == t || null == (m = t.common)
                                ? void 0
                                : m.traceparent) ||
                            this.config.params.common.traceparent,
                        N =
                            (null == t || null == (w = t.common)
                                ? void 0
                                : w.referer) ||
                            this.config.params.common.referer,
                        P = {
                            authorization:
                                void 0 !== f ? "OAuth ".concat(f) : void 0,
                            "x-yandex-music-client": b,
                            "accept-language": k,
                            "x-yandex-music-device": T,
                            "x-yandex-music-multi-auth-user-id":
                                void 0 !== C ? String(C) : void 0,
                        };
                    return (
                        void 0 !== I && (P["x-ya-user-ticket"] = I),
                        void 0 !== S && (P["x-ya-service-ticket"] = S),
                        _ &&
                            (P["x-yandex-music-without-invocation-info"] = "1"),
                        void 0 !== A && (P["x-yandex-icookie"] = A),
                        void 0 !== R && (P["x-request-id"] = R),
                        void 0 !== O && (P["x-forwarded-for-y"] = O),
                        void 0 !== D && (P.tracestate = D),
                        void 0 !== x && (P.traceparent = x),
                        void 0 !== N && (P.referer = N),
                        P
                    );
                }
