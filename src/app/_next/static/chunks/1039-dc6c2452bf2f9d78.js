    ...
    26371: function (e, t, i) {
      ...
      let Q = (0, L.Pi)((e) => {
          ...
          return i
            ? (0, w.jsx)(K.rU, {
                ...
                href: i,
                onClick: n.close,
                children: (0, w.jsx)(J.Caption, {
                  variant: "div",
                  size: "l",
                  children: t,
                }),
              })
            : (0, w.jsx)(J.Caption, { variant: "div", size: "l", children: t });
        }),
        $ = (e) => {
      ...
      let eX = (e) => {
        ...
        return (0, w.jsx)(eW, {
          id: eS,
          className: t,
          contentClassName: eY().content,
          heading: (0, w.jsxs)(w.Fragment, {
            children: [
              (0, w.jsx)(ed.J, {
                variant: "musicLogoCenter".concat(n),
                className: eY()["logo_".concat(n.toLocaleLowerCase())],
              }),
              (0, w.jsx)(eI.y, {
                children: (0, w.jsx)(J.Heading, {
                  variant: "h2",
      ...
      let tR = () =>
        ...
        tO = () => {
          let e = (0, R.useSearchParams)().get("paywall-country"),
            t = (0, M.useMemo)(() => {
              switch (e) {
                case a.RB:
                  return (0, w.jsx)(tx, {});
      ...
      let tK = (0, L.Pi)((e) => {
        ...
        return (0, w.jsxs)("div", {
          className: (0, E.W)(tq().root, {
            [tq().root_applicationPreserveTitleBar]: h,
            [tq().root_withBarBelow]: p,
          }),
          children: [
            (0, w.jsx)(el.wp, {
              className: (0, E.W)(tq().navbar, {
                [tq().navbar_application_macos]: _,
                [tq().navbar_application_windows]: h,
              }),
            }),
            (0, w.jsx)(H, {
              className: (0, E.W)(tq().content, {
                [tq().content_withPlayerBar]: u,
              }),
              children: (0, w.jsxs)(
                K.SV,
                {
                  ...
                  children: [
                    a,
                    (0, w.jsx)(T.Notification, {
                      className: tq().notificationInfoContainer,
                      enableMultiContainer: !0,
                      containerId: D.W$x.INFO,
                      position: "bottom-center",
                    }),
                    (0, w.jsx)(T.Notification, {
                      className: tq().notificationErrorContainer,
                      enableMultiContainer: !0,
                      containerId: D.W$x.ERROR,
                      position: "bottom-center",
                      limit: 1,
            ...
            (0, w.jsx)(tD.ev, { className: tq().playerBar }),
            m &&
              c.list &&
              (0, w.jsx)(tW.On, {
                className: tq().barBelow,
    ...
    22003: function (e, t, i) {
      ...
      let k = (0, s.Pi)((e) => {
        let {
          ...
          [q, K] = (0, o.useState)(!1),
          { isPlaying: J, togglePlay: Y } = (0, v.qmq)({
            playContextParams: {
              contextData: {
                type: d.Ak.Playlist,
          ...
          X = (0, o.useCallback)(() => {
            z({ to: l.qU.PlaylistScreen }), null == R || R();
          }, [z, R]),
          Q = (0, o.useCallback)(
            (e) => {
              X(), H(e);
    ...
    78457: function (e, t, i) {
      ...
      let R = (0, a.Pi)((e) => {
        ...
        T = (0, a.Pi)((e) => {
          ...
          let w = (0, s.useMemo)(() => (u ? (a ? R : S) : a ? C : b), [a, u]);
          return (0, n.jsx)(w, {
            className: m,
      ...
      let h = "vibe-animation",
        x = (0, a.Pi)((e) => {
          ...
          let { className: g } = e,
            ...
            { theme: S } = (0, u.FgM)(),
            N = (0, u.jpI)(),
            w = j.status === c.Xz.PLAYING && j.contextType === r.Ak.Vibe;
          return (
            (0, s.useEffect)(() => {
              if (b.current) {
                var e, t;
