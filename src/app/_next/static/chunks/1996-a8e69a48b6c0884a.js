    ...
    [1996, 9366],
    {
        4585: (e, i, t) => {
            ...
            var s = function () {
                    return (s =
                        Object.assign ||
                        function (e) {
                            for (var i, t = 1, s = arguments.length; t < s; t++)
                        ...
                        (this.endVal = i),
                            ...
                            (this.formatNumber = function (e) {
                                ...
                                if (
                                    ...
                                    (t =
                                        o.length > 1
                                            ? n.options.decimal + o[1]
                                            : ""),
                                    n.options.useGrouping)
                                ) {
                                    s = "";
                                    for (
                                        var r = 3, l = 0, a = 0, d = i.length;
                                        a < d;
                                        ++a
                                    )
                            ...
                            (this.easeOutExpo = function (e, i, t, s) {
                                return (
                                    (t *
                                        (1 - Math.pow(2, (-10 * e) / s)) *
                                        1024) /
                            ...
                            (this.options = s(s({}, this.defaults), t)),
                        ...
                        (e.prototype.determineDirectionAndSmartEasing =
                            function () {
                                ...
                                if (
                                    ...
                                    (this.endVal =
                                        e + i * this.options.smartEasingAmount),
        ...
        55498: (e, i, t) => {
            Promise.resolve().then(t.bind(t, 52283)),
                ...
                Promise.resolve().then(t.bind(t, 51991)),
                Promise.resolve().then(t.t.bind(t, 22867, 23)),
                Promise.resolve().then(t.t.bind(t, 35519, 23)),
                Promise.resolve().then(t.bind(t, 65520)),
                Promise.resolve().then(t.t.bind(t, 96798, 23)),
                Promise.resolve().then(t.t.bind(t, 62019, 23)),
                Promise.resolve().then(t.bind(t, 91396)),
        ...
        91396: (e, i, t) => {
            ...
            var s = t(33008),
                ...
                V = t.n(x);
            let E = (e) => {
                let { isFirstSlide: i, isLastSlide: t, style: n } = e,
                    o = (0, S.Mn)(),
            ...
            let C = (e) => {
                var i;
                let { slide: t, isVisible: o } = e,
                    r = (0, _.eGp)(),
                    { from: a } = (0, _.fyy)({
                        pageId: _._Q$.TRAILER_OF_THE_YEAR,
                        blockId: _.UfI.DEFAULT,
                    }),
                    { isActive: d } = (0, S.JO)();
                (0, _.GWZ)(o);
                let h =
                        null == r
                            ? void 0
                            : r.getState(_.V_r.TRAILER).queueState.entityList
                                  .value,
                    m = (0, l.useMemo)(
                        () =>
                            t.entitiesData &&
                            h &&
                            t.entitiesData.every((e, i) => {
                                var t;
                                return (
                                    e.meta.id ===
                                    (null == (t = h[i])
                    ...
                    u =
                        ...
                        (!m ||
                            (null == r
                                ? void 0
                                : r.getState(_.V_r.TRAILER).playerState.status
                                      .value) !== P.MT.PLAYING),
                    v =
                        u &&
                        (null == r ||
                        null ==
                            (i = r.getState(_.V_r.TRAILER).currentContext.value)
                            ? void 0
                            : i.data.meta.id) === t.id;
                return (
                    (0, l.useEffect)(() => {
                        if (v)
                            return void r.restartContext(
                                {
                                    playAfterRestart: !0,
                                    queueParams: { index: 0 },
                    ...
                    (0, s.jsx)(w.Paper, {
                        ...
                        radius: "l",
                        tabIndex: 0,
                        children: (0, s.jsx)(f.AR, { slide: t, isActive: d }),
                    })
                );
            };
            var T = t(90720),
            ...
            let F = (0, o.PA)((e) => {
                ...
                let P = (0, l.useCallback)(
                    (e) => {
                        v(e.isBeginning),
                            b(e.isEnd),
                            o.setActiveSlide(e.activeIndex);
                    },
                    [o],
                );
                return (0, s.jsx)("div", {
                    className: (0, n.$)(N().root, { [N().root_visible]: d }),
                        ...
                        children: [
                            i.map((e, t) =>
                                (0, s.jsx)(
                                    S.qr,
                                    {
                                        children: (0, s.jsx)(_.Rau, {
                                            slidesType: (0, f.tS)(o.consumer),
                                            slideId: e.id,
                                            slidesCount: i.length,
                                            slidePos: t + 1,
                                            videoId: e.background.videoUrl,
                                            artistId: o.artistId,
                                            children: (0, s.jsx)(C, {
                                                isVisible: o.activeSlide === t,
                                                slide: e,
                                            }),
                                        }),
                                    },
                            ...
                            (0, s.jsx)(E, { isFirstSlide: u, isLastSlide: c }),
                        ],
                    }),
                });
            });
            ...
            function D(e, i) {
                return (
                    (e === _.GuX.RESOLVE || e === _.GuX.REJECT) &&
                    0 === i.length
                );
            }
            let L = (0, o.PA)((e) => {
                ...
                let {
                    ...
                    I = (0, _.eGp)(),
                    w =
                        V.checkExperiment(_.zal.WebNextRewind2024, "on") ||
                        V.checkExperiment(_.zal.WebNextMusicBirthday2025, "on"),
                    y =
                        !(null == (i = A.browserInfo) ? void 0 : i.isMobile) ||
                        !A.browserInfo.isTouch,
                    k = null == I ? void 0 : I.getState(_.V_r.TRAILER),
                    C = (0, m.c)((e) => {
                ...
                (0, l.useEffect)(
                    ...
                    (0, l.useEffect)(() => {
                        E.status === P.MT.PLAYING &&
                            (null == I || I.togglePause());
                    }, [I, E.status]);
                let N = (0, l.useMemo)(() => {
                    switch (t) {
                        case f.z6.USER:
                ...
                (0, l.useEffect)(() => {
                    if (w)
                        switch (t) {
                            case f.z6.USER:
                                D(x.userSlidesLoadingState, N) &&
                                    (0, r.notFound)();
                                break;
                            case f.z6.ARTIST:
                                D(x.artistSlidesLoadingState, N) &&
                                    (0, r.notFound)();
                                break;
                            case f.z6.PODCAST:
                                D(x.podcastSlidesLoadingState, N) &&
                                    (0, r.notFound)();
                                break;
                            case f.z6.SPECIAL:
                                D(x.specialSlidesLoadingState, N) &&
                                    (0, r.notFound)();
                        }
                    else (0, r.notFound)();
                }, [
                ...
                let R = (0, l.useMemo)(() => {
                        ...
                        let i,
                            t =
                                null == (e = N[x.activeSlide])
                                    ? void 0
                                    : e.slideColor;
                        if (t) {
                            let { r: e, g: s, b: n } = (0, _.E2N)(t);
                            i = "rgba("
                                .concat(e, ", ")
                                .concat(s, ", ")
                                .concat(n, ", 0.5)");
                        ...
                        return {
                            "--card-color-enabled_variant": t,
                            "--card-color-enabled": i,
                            "--logo-color": t,
                        };
                    ...
                    L = (0, l.useCallback)(() => {
                        x.toggleMute(),
                            (null == k
                                ? void 0
                                : k.playerState.exponentVolume.value) !== 0
                                ? C(0)
                                : C(1);
                    }, [
                        C,
                        x,
                        null == k ? void 0 : k.playerState.exponentVolume.value,
                    ]),
                ...
                switch (t) {
                    case f.z6.USER:
                        x.userSlidesLoadingState === _.GuX.IDLE &&
                            (0, l.use)(x.getUserSlides());
                        break;
                    case f.z6.ARTIST:
                        o &&
                            x.artistSlidesLoadingState === _.GuX.IDLE &&
                            (0, l.use)(x.getArtistSlides({ artistId: o }));
                        break;
                    case f.z6.PODCAST:
                        p &&
                            x.podcastSlidesLoadingState === _.GuX.IDLE &&
                            (0, l.use)(
                                x.getPodcastSlides({ podcastId: Number(p) }),
                            );
                        break;
                    case f.z6.SPECIAL:
                        S &&
                            x.specialSlidesLoadingState === _.GuX.IDLE &&
                            (0, l.use)(x.getSpecialSlides({ campaignId: S }));
                }
                return (0, s.jsxs)("div", {
                    className: j().root,
                    style: R,
                    ...(0, h.Am)(h.Xk.slides.SLIDES_PAGE),
                    children: [
                        (0, s.jsx)(c.q, {
        ...
        99366: (e, i, t) => {
            ...
            let u = (e) => {
                let { children: i } = e,
                    { state: t, toggleTrue: d } = (0, r.e)(!1),
                    { state: u, toggleTrue: v } = (0, r.e)(!1),
                    { getThemeFromStorage: c } = (0, a.QDo)(new l.si()),
                    b = (0, o.useMemo)(() => {
                        var e;
                        return null != (e = c()) ? e : (0, a.VDQ)();
                    }, [c]),
                    P = (0, o.useCallback)(
                        (e) => {
                            let i = m.env.ASSET_PREFIX || "";
                            return ""
                                .concat(
                                    i,
                    ...
                    p = (0, o.useMemo)(() => ({ isVisible: !t }), [t]);
                return (0, s.jsxs)(a.nlO.Provider, {
                    value: p,
                    children: [
                        !t &&
                            (0, s.jsx)("div", {
