  ...
  [3490],
  {
      ...
      let u = a.V5.model("TrackPosition", {
        ...
        c = a.V5.compose(
          a.V5.model({
            ...
            hslAverageColor: a.V5.maybe(a.V5.string),
    ...
    93490: function (e, t, i) {
      ...
      let C = (e) => {
        ...
        let {
          ...
          c = "";
        if (null === (t = a.cover) || void 0 === t ? void 0 : t.color) {
          let { h: e, s: t } = (0, k.sE)(
            null === (n = a.cover) || void 0 === n ? void 0 : n.color,
          );
          c = "hsl(".concat(e, ", ").concat(t, "%, ").concat(20, "%)");
        }
        return (0, d.pj)({
          id: a.id,
          title: a.title,
          coverUri: null === (i = a.cover) || void 0 === i ? void 0 : i.uri,
          type: a.albumType,
          contentWarning: a.contentWarning,
          disclaimers: a.disclaimers,
          artists: null == s ? void 0 : s.map(b.tR),
          averageColor:
            null === (r = a.cover) || void 0 === r ? void 0 : r.color,
          hslAverageColor: c,
      ...
      let g = (e) => {
        ...
        return (0, d.pj)({
          ...C({ album: t, artists: i, likesCount: r }),
          chart: n && (0, f.W5)(n),
        });
      };
      var h = i(11856),
        ...
        let {
          ...
          Y = (0, s.useMemo)(() => {
            ...
            let t = B(
              ...
              i = a.isLiked ? B({ id: "entity-names.has-your-like" }) : "";
            return ""
              .concat(t, " ")
              .concat(null !== (e = a.version) && void 0 !== e ? e : "", " ")
              .concat(i);
          }, [B, a.title, a.isLiked, a.version]),
          { isPlaying: H, togglePlay: X } = (0, g.qm)({
            playContextParams: {
              contextData: { type: c.Ak.Album, meta: { id: a.id }, from: O },
              loadContextMeta: !0,
            },
          }),
          ee = (0, A.useAlbumDisclaimer)({ album: a, callback: F }),
          et = (0, A.useAlbumDisclaimer)({ album: a, callback: X }),
          ei = (0, s.useCallback)(
            (e) => {
              D({ to: o.qU.AlbumScreen }), null == w || w(), ee(e);
            },
            [D, w, ee],
          ),
          er = (0, s.useCallback)(
          ...
          }, [a.isAvailable, a.isLiked, ec, ea, en, z, G, H, a.isPinned, K]),
          em = (0, s.useMemo)(
            () =>
              (0, r.jsx)(p.Paper, {
                className: V().cover,
            ...
            [er, a.coverUri, a.isAvailable, Y, J, ed],
          );
    ...
    41566: function (e, t, i) {
      ...
      let c = (0, n.Pi)((e) => {
        ...
        let P = (0, a.useMemo)(() => {
            if (!f)
              return (0, r.jsx)(u.Zd, { onClick: k, isPinned: i.isPinned });
          }, [i.isPinned, k, f]),
          L = (0, a.useMemo)(
            () =>
              g
          ...
          U = (0, a.useMemo)(() => {
            if (!g && h) return (0, r.jsx)(u.NB, { onClick: j });
          }, [j, g, h]),
          N = (0, a.useMemo)(() => {
            if (!g)
              return (0, r.jsx)(u.GQ, {
    ...
    24298: function (e, t, i) {
      ...
      let g = (0, a.Pi)((e) => {
        let {
          ...
          { ref: g, intersectionPropertyId: h } = (0, _.Vf)(),
          { formatMessage: A, formatDate: y } = (0, l.Z)(),
          x = (0, v.IK)(a),
          V = (0, s.useMemo)(() => {
            let e = A(
              ...
              t = a.isPresave ? A({ id: "entity-names.has-your-like" }) : "";
            return "".concat(e, " ").concat(t);
          }, [A, a.title, a.isPresave]),
          j = (0, s.useMemo)(
            () =>
              (0, r.jsxs)(m.Paper, {
                className: f().cover,
