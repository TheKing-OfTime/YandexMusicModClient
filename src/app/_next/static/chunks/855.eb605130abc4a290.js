    ...
    [855],
    {
        ...
        44865: (e, t, r) => {
            ...
            let i = (e) => null !== e && "object" == typeof e,
                n = (...e) => {
                    for (let t of e)
                        if ((!i(t) || Array.isArray(t)) && void 0 !== t)
                            throw TypeError(
                    ...
                    for (let o of e)
                        if (Array.isArray(o))
                            ...
                            for (let [e, r] of Object.entries(o))
                                i(r) && e in t && (r = u(t[e], r)),
                                    (t = { ...t, [e]: r });
                            i(o.headers) &&
                                ((r = a(r, o.headers)), (t.headers = r));
                        }
                    return t;
                },
                l = (() => {
            ...
            async function w(e, { signal: t }) {
                return new Promise((r, o) => {
                    if (t) {
                        if (t.aborted) return void o(v(t));
            ...
            class T {
                static create(e, t) {
                    let r = new T(e, t),
                        s = async () => {
                            if (r._options.timeout > 0x7fffffff)
                                throw RangeError(
                            ...
                            if (
                                (r._decorateResponse(e),
                                !e.ok && r._options.throwHttpErrors)
                            ) {
                                let t = new o.H(e, r.request, r._options);
                                for (let e of r._options.hooks.beforeError)
                                    t = await e(t);
                                throw t;
                            }
                            if (r._options.onDownloadProgress) {
                                if (
                                    "function" !=
                                    typeof r._options.onDownloadProgress
                                )
                                    throw TypeError(
                                ...
                                return r._stream(
                                    e.clone(),
                                    r._options.onDownloadProgress,
                                );
                            }
                            return e;
                        },
                        i = r._options.retry.methods.includes(
                        ...
                        i[e] = async () => {
                            ...
                            if ("json" === e) {
                                if (
                                    204 === s.status ||
                                    0 ===
                                        (await s.clone().arrayBuffer())
                                            .byteLength
                                )
                                    return "";
                                if (t.parseJson)
                                    return t.parseJson(await s.text());
                            }
                            return s[e]();
                        };
                    return i;
                ...
                constructor(e, t = {}) {
                    if (
                        ...
                        (this._options = {
                            credentials:
                                this._input.credentials || "same-origin",
                            ...t,
                            ...
                            method: ((e) =>
                                c.includes(e) ? e.toUpperCase() : e)(
                                t.method ?? this._input.method,
                            ),
                    ...
                    if (
                        ...
                        this._options.prefixUrl.endsWith("/") ||
                            (this._options.prefixUrl += "/"),
                            (this._input =
                                this._options.prefixUrl + this._input);
                    }
                    if (h) {
                        if (
                    ...
                    if (
                        ...
                        let e =
                            ...
                            t = this.request.url.replace(
                                /(?:\?.*?)?(?=#|$)/,
                                "?" + e,
                            );
                        ((p &&
                            this._options.body instanceof
                                globalThis.FormData) ||
                    ...
                    void 0 !== this._options.json &&
                        ...
                        this.request.headers.set(
                            "content-type",
                            this._options.headers.get("content-type") ??
                                "application/json",
                        ),
                ...
                _decorateResponse(e) {
                    return (
                        this._options.parseJson &&
                            (e.json = async () =>
                                this._options.parseJson(await e.text())),
                        e
                    );
                }
                async _retry(e) {
                    try {
                        ...
                        let t = Math.min(
                            this._calculateRetryDelay(r),
                            0x7fffffff,
                        );
                        if (0 !== t && this._retryCount > 0) {
                            for (let e of (await w(t, {
            ...
            let O = (e) => {
                    ...
                    for (let r of c)
                        t[r] = (t, o) => T.create(t, n(e, o, { method: r }));
                    return (
                        (t.create = (e) => O(n(e))),
                        (t.extend = (t) => O(n(e, t))),
                        (t.stop = d),
                    ...
                    null == t &&
                        (t = function (e, t) {
                            return r[0] === t
                                ? "[Circular ~]"
                                : "[Circular ~." +
                                      o.slice(0, r.indexOf(t)).join(".") +
                                      "]";
                        }),
                    function (s, i) {
                        if (r.length > 0) {
                            var n = r.indexOf(this);
                            ~n ? r.splice(n + 1) : r.push(this),
                                ~n ? o.splice(n, 1 / 0, s) : o.push(s),
                                ~r.indexOf(i) && (i = t.call(this, s, i));
                        } else r.push(i);
            ...
            class o extends Error {
                constructor(e, t, r) {
                    let o = e.status || 0 === e.status ? e.status : "",
                        ...
                        i = `${o} ${s}`.trim();
                    super(
                        `Request failed with ${i ? `status code ${i}` : "an unknown error"}`,
                    ),
                ...
                off: function (e, t) {
                    ...
                    if (o && t)
                        for (var i = 0, n = o.length; i < n; i++)
                            o[i].fn !== t && o[i].fn._ !== t && s.push(o[i]);
