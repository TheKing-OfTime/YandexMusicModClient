  ...
  [8101],
  {
    ...
    46813: function (e, t, n) {
      ...
      let p = (e) => {
          ...
          return (0, r.jsx)(c.Yj, {
            className: (0, a.W)(f().root, f().important),
            message: p,
          });
        },
        modUpdateToast = (e) => {
        ...
        v = () => {
          ...
          (0, o.useEffect)(() => {
            ...
            return (
              null === (e = window.desktopEvents) ||
                void 0 === e ||
                e.on(l.BOn.UPDATE_AVAILABLE, a),
              () => {
                var e;
                null === (e = window.desktopEvents) ||
                  void 0 === e ||
                  e.off(l.BOn.UPDATE_AVAILABLE, a);
              }
            );
          }, [a]);
            (0, o.useEffect)(() => {
    ...
    64422: function (e, t, n) {
      ...
      let l = () => {
        let {
            ...
            n.getData(),
              ...
              l.landing.isLoaded &&
                l.landing.getSkeleton(
                  { id: o.jB.WEB_MAIN, showWizard: a.settings.showWizard },
                  { preloadBlocks: 2 },
                ),
              t.landing.isLoaded &&
          ...
          }, [t.landing, n, e, l.landing, a.settings.showWizard]);
        (0, r.useEffect)(() => {
          var e;
          return (
            null === (e = window.desktopEvents) ||
              void 0 === e ||
              e.on(i.BOn.REFRESH_APPLICATION_DATA, u),
            () => {
              var e;
              null === (e = window.desktopEvents) ||
                void 0 === e ||
                e.off(i.BOn.REFRESH_APPLICATION_DATA, u);
            }
          );
        }, [u]);
      };
    ...
    88909: function (e, t, n) {
      ...
      let p = s.V5.model("ContextItem", {
        ...
        g = s.V5.model("VibeSettings", {
          loadingState: s.V5.enumeration(Object.values(a.Gui)),
          ...
          .views((e) => ({
            get isNeededToLoad() {
              return e.loadingState === a.Gui.IDLE;
            },
          }))
          .actions((e) => ({
      ...
      var h = n(9753),
        ...
        O = {
          6011: (e, t, n) => {
                ...
                x = er(
                  i.convertOffsetParentRelativeRectToViewportRelativeRect
                    ? await i.convertOffsetParentRelativeRectToViewportRelativeRect(
                        { rect: h, offsetParent: y, strategy: u },
                      )
                    : h,
                );
              return {
                  ...
                  void 0 === e && (e = {}),
                  {
                    ...
                    async fn(t) {
                      ...
                      let {
                        ...
                        h = await el(t, m),
                        y =
                          (null == (n = a.autoPlacement) ? void 0 : n.index) ||
                          0,
                        b = g[y];
                      if (null == b) return {};
                      let x = J(
                      ...
                      if (u !== b) return { reset: { placement: g[0] } };
                      let E = [h[Z(b)], h[x[0]], h[x[1]]],
                        w = [
                          ...((null == (r = a.autoPlacement)
                            ? void 0
                            : r.overflows) || []),
                  ...
                  void 0 === e && (e = {}),
                  {
                    ...
                    async fn(t) {
                      ...
                      let C = [c, ..._],
                        R = await el(t, b),
                        S = [],
                        T = (null == (r = u.flip) ? void 0 : r.overflows) || [];
                      if ((p && S.push(R[x]), v)) {
                        let e = J(a, s, w);
                        S.push(R[e[0]], R[e[1]]);
                      }
                      if (
                        ((T = [...T, { placement: a, overflows: S }]),
                        !S.every((e) => e <= 0))
                      ) {
                        let e =
                            ((null == (o = u.flip) ? void 0 : o.index) || 0) +
                            1,
                          t = C[e];
                        if (t)
                          return {
                ...
                return (
                  void 0 === e && (e = {}),
                  {
                    ...
                    async fn(t) {
                      ...
                      await u({ ...t, availableWidth: x, availableHeight: b });
            ...
            function eS(e) {
              return eR(s(e)).left + b(e).scrollLeft;
            }
            function eT(e, t, n) {
              let r;
              if ("viewport" === t)
            ...
            function ek(e, t) {
              ...
              return r &&
                ("html" === a(r) ||
                  ("body" === a(r) && "static" === y(r).position && !m(r)))
                ? n
                : r ||
                    (function (e) {
                      let t = x(e);
              ...
              eM = (e) => ({
                ...
                fn(t) {
                  ...
                  if (n && {}.hasOwnProperty.call(n, "current")) {
                    if (null != n.current)
                      return ea({ element: n.current, padding: r }).fn(t);
                  } else if (n) return ea({ element: n, padding: r }).fn(t);
                  return {};
                },
              });
            var eB =
                ...
                for (var o = [], i = Array.from(t); i.length; ) {
                  ...
                  if (!eH(l, !1)) {
                    if ("SLOT" === l.tagName) {
                      ...
                      r.flatten
                        ? o.push.apply(o, u)
                        : o.push({ scopeParent: l, candidates: u });
                    } else {
                      eW.call(l, eG) &&
                        r.filter(l) &&
                        (n || !t.includes(l)) &&
            ...
            function tb(e) {
              ...
              return (
                ...
                tm(() => {
                  let e = o.current ? u.get(o.current) : null;
                  null != e && r(e);
                }, [u]),
            ...
            let tE = l.createContext({ activeIndex: 0, onNavigate: () => {} }),
              ...
              tS = l.forwardRef(function (e, t) {
                let { render: n, ...r } = e,
                  ...
                  { activeIndex: i, onNavigate: a } = l.useContext(tE),
                  { ref: u, index: s } = tb(),
                  c = te([u, t, o.ref]),
                  d = i === s;
                return tx(n, {
            ...
            function tH(e, t) {
              ...
              return (
                l.useEffect(() => {
                  if (c && d(a))
                    return (
                      ...
                      g && a.addEventListener("mousemove", i, { once: !0 }),
                      ...
                      () => {
                        n && a.removeEventListener("mouseleave", s),
                          ...
                          g && a.removeEventListener("mousemove", i),
                  ...
                  function l(r) {
                    ...
                    ("touch" === E.current && _(u, r.relatedTarget)) || N(r);
                  }
                  function s(n) {
                    t() ||
                      null == b.current ||
                ...
                }, [a, u, c, e, v, m, g, N, L, A, r, n, h, x, b, o]),
                tm(() => {
                  var e, t, r;
                  if (
                    c &&
            ...
            let tK = l.createContext({
              ...
              tZ = (e) => {
                ...
                return (
                  tm(() => {
                    o.currentId
                      ? null === a.current
                        ? (a.current = o.currentId)
                        : i({ isInstantPhase: !0 })
                      : (i({ isInstantPhase: !1 }), (a.current = null));
                  }, [o.currentId]),
                  l.createElement(
                    tK.Provider,
                    {
                      value: l.useMemo(
                        () => ({ ...o, setState: i, setCurrentId: u }),
                        [o, i, u],
                      ),
                    },
                    t,
              ...
              tX = (e, t) => {
                ...
                tm(() => {
                  i &&
                    (u({ delay: { open: 1, close: tz(a, "close") } }),
                    i !== o && r(!1));
                }, [o, r, u, i, a]),
                  tm(() => {
                    function e() {
                      r(!1), u({ delay: a, currentId: null });
                    }
                    if (!n && i === o) {
                      if (s) {
            ...
            function t5(e, t, n) {
              ...
              return (function (e, t, n, r) {
                let o = "data-floating-ui-inert",
                  ...
                  u = new Set(l),
                  s = [];
                tJ[o] || (tJ[o] = new WeakMap());
                let c = tJ[o];
                return (
                  l.forEach(function e(t) {
                    !(!t || a.has(t)) &&
                      (a.add(t), t.parentNode && e(t.parentNode));
                  }),
                  (function e(t) {
                    !t ||
                      u.has(t) ||
                  ...
                  () => {
                    s.forEach((e) => {
                      ...
                      t$.set(e, t),
                        c.set(e, n),
                        t ||
                          (!tQ.has(e) && i && e.removeAttribute(i),
                          tQ.delete(e)),
                ...
                l.useEffect(() => {
                  ...
                  if (x) {
                    let e = [
                        ...
                        I.current,
                        A.current,
                        T.current.includes("reference") || C ? b : null,
                      ].filter((e) => null != e),
                      n = s || C ? t5(e, S, !S) : t5(e);
                    return () => {
                      n();
                ...
                return (
                  tm(() => {
                    ...
                    let e = /iP(hone|ad|od)|iOS/.test(C()),
                      ...
                      a = t.top ? parseFloat(t.top) : window.pageYOffset;
            ...
            function nv(e, t) {
              ...
              return (
                ...
                tm(() => {
                  a && (null != c || null != d) && ((f.current = !1), y(c, d));
                }, [a, c, d, y]),
                l.useMemo(() => {
                  if (!a) return {};
                  function e(e) {
            ...
            function ny(e, t) {
              ...
              return (
                ...
                }, [c, s, u, a, v, I, g, n, r, C, p, D, V, U, F, W, z, G, H]),
                l.useEffect(() => {
                  B.current = !1;
                }, [I, g]),
                l.useMemo(
            ...
            function nO(e, t) {
              ...
              tm(() => {
                ...
                tm(() => {
                  if (d && n && a) {
                    if (null == s) {
                      ...
                      tu(u, s) ||
                        ((V.current = s), J(u, V, H.current), (H.current = !1));
                  }
                }, [d, n, a, s, p, g, u, R, h, B, J, K]),
                tm(() => {
                  var e, t;
                  if (!d || a || !M || y || !W.current) return;
                ...
                tm(() => {
                  ...
                  function e(e) {
                    Q(e.id), I && (I.current = e);
                  }
                }, [d, M, y, A, I]),
                tm(() => {
                  (U.current = B), (W.current = !!a);
                }),
                tm(() => {
                  n || (F.current = null);
                }, [n]);
              ...
              return l.useMemo(() => {
                ...
                function t(t) {
                  ...
                  let l = V.current,
                    ...
                    s = tc(u, e);
                  if (
                    ("Home" === t.key && (j(t), (V.current = a), B(V.current)),
                    ...
                    if (
                      ...
                      (V.current = nS(t.key, R, h) ? a : s), B(V.current);
                      return;
                    }
                    nS(t.key, R, h)
                      ? m
                        ? (V.current =
                            l >= s
                              ? v && l !== u.current.length
                                ? -1
                                : a
                              : td(u, { startingIndex: l, disabledIndices: e }))
                        : (V.current = Math.min(
                            s,
                            td(u, { startingIndex: l, disabledIndices: e }),
                          ))
                      ...
                      tu(u, V.current) ? B(null) : B(V.current);
                  }
                }
                function l(e) {
                  "auto" === b && S(e.nativeEvent) && (D.current = !0);
                }
                let a = y && n && ee && { "aria-activedescendant": $ || X },
                  s = u.current.find((e) => (null == e ? void 0 : e.id) === X);
                return {
                  reference: {
                    ...a,
                    onKeyDown(o) {
                              ...
                              n =
                                b && !t
                                  ...
                                  : m
                                    ? s
                                    : null;
                            n && (j(o), n.dispatchEvent(e), Q(void 0));
                          }
                          if (
                            x &&
                            i.context &&
            ...
            function nP(e, t) {
              ...
              let {
                ...
                { isMounted: g, status: h } = nI(e, { duration: a }),
                y = tU(n),
                b = tU(r),
                x = tU(o),
                E = tU(i);
            ...
            function nA(e, t) {
              ...
              let { open: r, dataRef: o } = e,
                ...
                m = l.useRef(),
                g = l.useRef(""),
                h = l.useRef(null != (n = null != v ? v : a) ? n : -1),
                y = l.useRef(null),
                b = tn(u),
                x = tn(s),
                E = tU(d),
              ...
              return (
                ...
                tm(() => {
                  if (r && "" === g.current) {
                    var e;
                    h.current = null != (e = null != v ? v : a) ? e : -1;
                  }
                }, [r, v, a]),
                l.useMemo(() => {
                  if (!c) return {};
            ...
            let nB = (e) => ({
              ...
              async fn(t) {
                ...
                return (
                  ...
                  o &&
                    (m.offsetHeight <
                      p.offsetHeight * Math.min(a, n.current.length - 1) - 1 ||
                    h.top >= -u ||
                    h.bottom >= -u
                      ? (0, eA.flushSync)(() => o(!0))
                      : (0, eA.flushSync)(() => o(!1))),
                      ...
                      if (!E && o) {
                        let t = (function (e, t) {
                          let n = performance.now(),
                            r = n - u;
                          if (null === l || null === a || 0 === r)
                            return (l = e), (a = t), (u = n), null;
                          let o = e - l,
                            i = t - a;
                          return (
                            (l = e),
          ...
          6169: (e, t, n) => {
            ...
            function p(e) {
              ...
              let { trackMouse: m } = e,
                ...
                h = r.useRef(Object.assign({}, u)),
                y = r.useRef(Object.assign({}, h.current));
              for (v in ((y.current = Object.assign({}, h.current)),
              (h.current = Object.assign(Object.assign({}, u), e)),
              u))
                void 0 === h.current[v] && (h.current[v] = u[v]);
              let [b, x] = r.useMemo(
                () =>
                  (function (e, t) {
                    let n = (t) => {
          ...
          6198: (e, t, n) => {
            ...
            let a = (e) => {
              ...
              s = (e) => {
                ...
                switch (i) {
                  case r.TOP:
                    n <= 0 && u({ ref: t, deltaY: n, deltaX: o, placement: i });
                    break;
                  case r.RIGHT:
                    o >= 0 && u({ ref: t, deltaY: n, deltaX: o, placement: i });
                    break;
                  case r.LEFT:
                    o <= 0 && u({ ref: t, deltaY: n, deltaX: o, placement: i });
                    break;
            ...
            t.Popover = (e) => {
              let {
                ...
                G = (0, l.useId)(),
                {
                  ...
                  open: M,
                  onOpenChange: B,
                  middleware: [(0, a.offset)(n), (0, a.flip)(), (0, a.shift)()],
                  whileElementsMounted: a.autoUpdate,
                  transform: m,
                }),
                H = (0, a.useTypeahead)(z, {
                  listRef: P,
                  onMatch: M ? L : void 0,
                  activeIndex: N,
                }),
                K = (0, a.useListNavigation)(z, {
                  listRef: I,
                  activeIndex: N,
                  nested: C,
                  onNavigate: L,
                }),
                Y = (0, a.useFloatingTree)(),
                Z = (0, a.useFloatingNodeId)(),
                X = (0, a.useFloatingParentNodeId)();
              (0, l.useEffect)(() => {
                if (!Y) return;
                let e = () => {
                    B(!1);
              ...
              let { handlers: q } = (0, u.usePopoverSwipeable)({
                  ref: U.floating,
                  onClose: V,
                  placement: d,
                  disableSwipe: !f,
                ...
                Q = (0, a.useRole)(z, S),
                J = (0, a.useDismiss)(z, { referencePress: !0 }),
                ee = (0, a.useClick)(z, { toggle: !C, ignoreMouse: C }),
                et = (0, a.useHover)(z, {
                  enabled: C,
                  handleClose: (0, a.safePolygon)({ blockPointerEvents: !0 }),
                }),
                ...
                }, []),
                {
                  ...
                  getFloatingProps: eo,
                  getItemProps: ei,
                } = (0, a.useInteractions)([Q, J, ee, et, K, H]),
                { isMounted: el, styles: ea } = (0, a.useTransitionStyles)(
                  z,
                  E,
                ),
                eu = (0, a.useMergeRefs)([U.setReference, A.ref]),
                es =
                  j &&
                  (0, l.cloneElement)(j, {
                    ref: eu,
      ...
      let W = (e) => {
        ...
        let { seed: o, title: i, isStation: l } = e,
          ...
          d = !!(null === (n = u.meta) || void 0 === n
            ? void 0
            : n.seeds.includes(o)),
          f = u.applyingSetting === o,
          p = (0, b.useMemo)(
            () =>
              d
        ...
        return {
          ...
          onClickHandler: (0, b.useCallback)(async () => {
            u.setApplyingSetting(o), await s(o, l), u.setApplyingSetting();
          }, [s, l, o, u]),
        };
      };
      var z = n(29715),
      ...
      let K = (0, y.Pi)((e) => {
          let { item: t } = e,
            ...
            s = (0, b.useCallback)(
              (e) => {
                n.isLoading ||
                  (r.current && (0, C.m)(e, H().ripple, r.current), u());
              },
              [u, n.isLoading],
            );
          return (0, h.jsxs)(R.z, {
      ...
      let J = {
        ...
        ee = (0, y.Pi)(() => {
          ...
          let { formatMessage: o } = (0, E.Z)(),
            { vibe: i, settings: l, vibeSettings: s } = (0, a.oR4)(),
            { pageId: c } = (0, a.lVB)(),
            { blockIdForFrom: d } = (0, a.qYG)(),
            f = (0, b.useRef)(null),
            p = (0, b.useRef)(null),
            { resetSettings: v } = (0, a.QhE)({
              seeds:
                null !==
                  (r =
          ...
          let T = (0, b.useCallback)(() => {
            ...
            L = (0, b.useCallback)(
              (e) => {
                if (!i.isLoading) {
                  var t;
                  f.current && (0, C.m)(e, Q().ripple, f.current),
                    v(),
            ...
            j = (0, b.useMemo)(() => {
              var e, t;
              if (u(null === (e = i.meta) || void 0 === e ? void 0 : e.seeds))
                return (
    ...
    58101: function (e, t, n) {
      ...
      let w = (0, o.Pi)(() => {
        ...
        e.landing.loadingState === y.Gui.IDLE &&
          (0, i.use)(
            e.landing.getSkeleton(
              { id: u.jB.WEB_MAIN, showWizard: t.settings.showWizard },
              { preloadBlocks: 2 },
            ),
          ),
        ...
        let T = n.checkExperiment(y.peG.WebNextDisableVibe, "on"),
          O = (0, i.useMemo)(
        ...
        return (0, r.jsx)(y.Lh6, {
          ...
          children: (0, r.jsx)(h.I7, {
            ...
            children: (0, r.jsxs)(c.t, {
              ...
              ref: C,
              ...(0, a.BA)(a.Br.main.MAIN_PAGE),
              children: [
                k,
                !T &&
                  (0, r.jsx)(y.Ja5, {
                    blockIdForFrom: y.BEo.RUP_MAIN_RADIO,
                    blockId: y.aUg.RUP,
                    blockType: y.aUg.RUP,
                    blockPosX: 0,
                    blockPosY: 0,
                ...
                (0, r.jsx)(b.$_, { className: E().footer }),
              ],
            }),
          }),
        });
    ...
    92324: function (e, t, n) {
      ...
      var r = n(9753),
        ...
        g = n.n(m);
      let h = (0, i.Pi)((e) => {
        let { isPlaying: t, onClick: n, ariaDisabled: i, className: c } = e,
          { vibe: d } = (0, f.oR4)(),
          { formatMessage: m } = (0, p.Z)(),
          h = t ? "pauseVibe" : "playVibe",
          y = t
          ...
          b = (0, l.useMemo)(
            () =>
              t
                ? m({ id: "vibe-actions.aria-label-pause" })
                : m({ id: "vibe-actions.aria-label-play" }),
            [m, t],
          ),
          x = (0, l.useCallback)(
            (e) => {
              d.isLoading || null == n || n(),
                e.stopPropagation(),
                e.preventDefault();
            },
            [n, d.isLoading],
        ...
        return (0, r.jsx)(s.z, {
          ...
          onClick: x,
          variant: "text",
          "aria-disabled": d.isLoading || i,
          "aria-label": b,
          icon: (0, r.jsx)(v.J, {
            size: "s",
            className: (0, o.W)(g().icon, g()["icon_".concat(h)]),
            variant: h,
          }),
          ...(0, u.BA)(y),
      ...
      let R = (0, i.Pi)((e) => {
          ...
          let { context: n, onResetClick: i, className: l } = e,
            { vibe: a, settings: d } = (0, f.oR4)(),
            { formatMessage: m } = (0, p.Z)(),
            g = (0, E.BV)(a.meta),
            h = d.layout === f.t8m.Mobile,
            y = n && !h;
          return (0, r.jsxs)("div", {
        ...
        S = (0, i.Pi)((e) => {
          var t, n, i;
          let { className: p } = e,
            { vibe: v, experiments: m } = (0, f.oR4)(),
            { pageId: g } = (0, f.lVB)(),
            { blockIdForFrom: y } = (0, f.qYG)(),
            { isFreemium: x } = (0, f.NMB)(),
            {
              isVibeContext: E,
              isPlaying: w,
              togglePlay: _,
            ...
            S = m.checkExperiment(f.peG.WebNextDisableVibeSettings, "on") || x;
          v.getLastLoadingState === f.Gui.IDLE && (0, l.use)(v.getLastVibe());
          let T = (0, l.useCallback)(() => {
              E
                ? C()
                : v.vibeResetLoadingState !== f.Gui.PENDING && v.vibeReset();
            }, [E, v, C]),
            O = (0, l.useCallback)((e) => {
          ...
          return (
            ...
            (0, r.jsxs)("div", {
              className: (0, o.W)(b().root, { [b().root_freemium]: x }, p),
              ...(0, u.BA)(u.QM.vibe.VIBE_BLOCK),
              children: [
                (0, r.jsx)(d.i, { className: b().vibeAnimation }),
                (0, r.jsxs)("div", {
                  ...
                  children: [
                    ...
                    x &&
                      (0, r.jsxs)(r.Fragment, {
                        children: [
                          (0, r.jsx)(c.Caption, {
                            className: b().availableInPlusText,
                            variant: "div",
                            size: "l",
      ...
      let k = T.V5.model("VibeActions", {
        meta: T.V5.maybeNull(E.KW),
        applyingSetting: T.V5.maybeNull(T.V5.string),
        isLoading: T.V5.boolean,
        getLastLoadingState: T.V5.enumeration(Object.values(f.Gui)),
        vibeResetLoadingState: T.V5.enumeration(Object.values(f.Gui)),
      })
        .views((e) => ({
          get isMyVibe() {
            return (
              e.meta && 1 === e.meta.seeds.length && e.meta.seeds[0] === f.sHr
            );
          },
        }))
        .actions((e) => ({
          getLastVibe: (0, T.ls)(function* () {
            ...
            if (e.getLastLoadingState !== f.Gui.PENDING)
              try {
                e.getLastLoadingState = f.Gui.PENDING;
                let n = yield t.waveLast();
                (e.meta = (0, E.xF)(n)),
                  (e.getLastLoadingState = f.Gui.RESOLVE);
              } catch (t) {
                n.error(t), (e.getLastLoadingState = f.Gui.REJECT);
              }
          }),
          vibeReset: (0, T.ls)(function* () {
            let { rotorResource: t, modelActionsLogger: n } = (0, T.dU)(e);
            if (e.vibeResetLoadingState !== f.Gui.PENDING)
              try {
                (e.vibeResetLoadingState = f.Gui.PENDING),
                  ...
                  (e.vibeResetLoadingState = f.Gui.RESOLVE);
              } catch (t) {
                n.error(t), (e.vibeResetLoadingState = f.Gui.REJECT);
              }
          }),
          ...
          reset() {
            (e.meta = null),
              (e.vibeResetLoadingState = f.Gui.IDLE),
              (e.getLastLoadingState = f.Gui.IDLE);
          },
        }));
    },
    8544: function (e) {
    ...
    52527: function (e) {
      e.exports = {
        ...
        availableInPlusText: "VibeBlock_availableInPlusText__LQxkb",
        buyPlusButton: "VibeBlock_buyPlusButton__62i4R",
      };
    },
    70705: function (e) {
      e.exports = {
