  ...
  [435],
  {
    70435: function (e, t, o) {
      ...
      let a = () => ({
        ...
        r = () => ({ project: "music.frontend.desktop", platform: "desktop" }),
        c = () => {
          var e, t;
          return {
            ...
            logger: {
              ...
              uaServerAddress:
                null !== (t = s.env.SERVER_UNIFIED_AGENT_ADDRESS) &&
                void 0 !== t
                  ? t
            ...
            oauthCredentials: {
              host: "https://oauth.yandex.".concat(n.M),
            ...
            passportCredentials: {
              host: "https://passport.yandex.".concat(n.M),
