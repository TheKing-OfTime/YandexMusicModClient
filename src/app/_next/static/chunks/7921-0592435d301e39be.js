  ...
  [7921],
  {
    57921: function (e, t, n) {
      ...
      let u = () => {
        ...
        C = (e) => {
          var t;
          let { isPlaying: n, canMoveBackward: s, canMoveForward: a } = e;
    ...
    75084: function (e, t, n) {
      ...
      let l = [
          ...
          [
            ...
            (e) => {
              var t;
              let n = (0, a.z)(e, "/album/:albumId/track/:trackId"),
                o = n.albumId;
              return null !== (t = (0, a.SZ)("/album/".concat(o))) &&
                void 0 !== t
                ? t
                : "/";
            },
    ...
    83001: function (e, t, n) {
      ...
      var o = n(8759),
        ...
        C = n.n(u);
      let _ = (e) => {
          let { version: t, formatMessage: n, closeToast: a } = e,
            u = (0, s.useCallback)(() => {
              var e;
              null === (e = window.desktopEvents) ||
                void 0 === e ||
        ...
        p = () => {
          let { formatMessage: e } = (0, a.Z)(),
            ...
            i = (0, s.useCallback)(
              (s, a) => {
                n.current !== a &&
                  ((n.current = a),
                  t((0, o.jsx)(_, { formatMessage: e, version: a }), {
          ...
          (0, s.useEffect)(() => {
            ...
            return (
              null === (e = window.desktopEvents) ||
                void 0 === e ||
                e.on(l.BO.UPDATE_AVAILABLE, i),
              () => {
                var e;
                null === (e = window.desktopEvents) ||
                  void 0 === e ||
                  e.off(l.BO.UPDATE_AVAILABLE, i);
              }
            );
          }, [i]);
        };
    ...
    46686: function (e, t, n) {
      ...
      ((o = s || (s = {})).PLAY = "PLAY"),
        (o.PAUSE = "PAUSE"),
        (o.TOGGLE_PLAY = "TOGGLE_PLAY"),
        (o.MOVE_BACKWARD = "MOVE_BACKWARD"),
        (o.MOVE_FORWARD = "MOVE_FORWARD"),
        (o.TOGGLE_REPEAT = "TOGGLE_REPEAT"),
        (o.REPEAT_NONE = "REPEAT_NONE"),
        (o.REPEAT_CONTEXT = "REPEAT_CONTEXT"),
        (o.REPEAT_ONE = "REPEAT_ONE"),
        (o.TOGGLE_SHUFFLE = "TOGGLE_SHUFFLE"),
        (o.TOGGLE_LIKE = "TOGGLE_LIKE"),
        (o.TOGGLE_DISLIKE = "TOGGLE_DISLIKE");
      let i = (e) => {
    ...
    33854: function (e, t, n) {
      ...
      let l = () => {
        let {
          ...
          }, [t.landing, n, e, l.landing, i.settings.showWizard]);
        (0, o.useEffect)(() => {
          var e;
          return (
            null === (e = window.desktopEvents) ||
