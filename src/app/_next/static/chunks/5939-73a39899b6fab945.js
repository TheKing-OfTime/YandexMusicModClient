                            ...
                            children: [
                                ...
                                (0, s.jsx)('div', {
                                    ...
                                    children: [
                                        ...
                                        (0, s.jsx)('span', { children: ['Подробности слияния можно прочитать тут: ', (0, s.jsx)('a', { children: 'https://pulsesync.dev/news/merging-with-ymmc', href: 'https://pulsesync.dev/news/merging-with-ymmc', target:"_blank", rel:"noreferrer noopener", className: 'buOTZq_TKQOVyjMLrXvB MergeNoteModal_link' })], style: { marginBottom: '10px', color: 'white' }}),
                                        ...
                                        (0, s.jsx)('span', { children: 'И продолжить использовать его пока инфраструктура ЯМ сильно не изменится.', style: { marginBottom: '20px' }}),
                                        (0, s.jsx)('div', {
                                            ...
                                            children: [
                                                (0, s.jsx)('button', {
                                                    ...
                                                    children: [
                                                        (0, s.jsx)('span', { children: 'Остаться на YMMC',
                                                            style: {
                                                                alignSelf: 'center'
                                                            }
                                                        }),
                                                ...
                                                (0, s.jsx)('button', {
                                                    ...
                                                    children: [
                                                        (0, s.jsx)('span', { children: 'Перейти на PulseSync',
                                                            style: {
                                                                alignSelf: 'center'
                                                            }
                                                        }),
