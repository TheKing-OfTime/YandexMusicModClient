    ...
    [5939],
    {
        ...
        7644: (e, t, o) => {
            ...
            let s = {
                ...
                width: 2880,
                blurDataURL:
                    "data:image/webp;base64,UklGRkIAAABXRUJQVlA4IDYAAADQAQCdASoIAAUAAkA4JZQCdAEOaA+wuAD+/SCh9NmVu/p31WSFlBGQJpSkM3AKDGRsZhmAAAA=",
                blurWidth: 8,
                blurHeight: 5,
            };
        },
                ...
                (0, s.useEffect)(() => {
                    ...
                    return (
                        null == (e = window.desktopEvents) ||
                            e.on(a.EE.PLAYER_ACTION, t),
                        () => {
                            var e;
                            null == (e = window.desktopEvents) ||
                                e.off(a.EE.PLAYER_ACTION, t);
                        }
                    );
                }, [t]);
            };
        ...
        12965: (e, t, o) => {
            ...
            let n = () => {
                ...
                (0, s.useEffect)(() => {
                    ...
                    return (
                        null == (e = window.desktopEvents) ||
                            e.on(l.EE.REFRESH_APPLICATION_DATA, i),
                        () => {
                            var e;
                            null == (e = window.desktopEvents) ||
                                e.off(l.EE.REFRESH_APPLICATION_DATA, i);
                        }
                    );
                }, [i]);
            };
        ...
        18275: (e, t, o) => {
            ...
            let n = () => {
                ...
                (0, s.useEffect)(() => {
                    ...
                    return (
                        null == (e = window.desktopEvents) ||
                            e.on(l.EE.PROBABILITY_BUCKET, t),
                        () => {
                            var e;
                            null == (e = window.desktopEvents) ||
                                e.off(l.EE.PROBABILITY_BUCKET, t);
                        }
                    );
                }, [t]);
            };
        ...
        22818: (e, t, o) => {
            ...
            let p = (0, a.PA)((e) => {
                ...
                return a.isAuthorized
                    ? t
                    : (o && (0, l.redirect)(h.Zyd.main.href),
                      (0, s.jsx)(_, {}));
            });
        },
        26271: (e) => {
            ...
            let r = [
                    ...
                    [
                        ...
                        (e) => {
                            ...
                            let o = new URLSearchParams(window.location.search),
                                s = (0, n.$cg)(o, t);
                            return "landing" === t.get(n.K3F.SCREEN)
                                ? "/?".concat(s.toString())
                                : ""
                ...
                i = () => {
                    let e = (0, s.useRouter)(),
                        t = (0, l.c)((t, o) => {
                            for (let [t, s] of r)
                                if (t.test(o)) return void e.push(s(o));
                            let { href: s } = (0, n.uvd)(
                                null != o ? o : n.Zyd.main.href,
                            );
                            e.push(s);
                        });
                    (0, a.useEffect)(() => {
                        ...
                        return (
                            null == (e = window.desktopEvents) ||
                                e.on(n.EE.OPEN_DEEPLINK, t),
                            () => {
                                var e;
                                null == (e = window.desktopEvents) ||
                                    e.off(n.EE.OPEN_DEEPLINK, t);
                            }
                        );
                    }, [t]);
                };
        ...
        38467: (e, t, o) => {
            ...
            let a = () => {
                    var e;
                    null == (e = window.desktopEvents) ||
                        e.send(s.EE.WINDOW_MINIMIZE);
                },
                l = () => {
                    var e;
                    null == (e = window.desktopEvents) ||
                        e.send(s.EE.WINDOW_MAXIMIZE);
                },
                n = () => {
                    var e;
                    null == (e = window.desktopEvents) ||
                        e.send(s.EE.WINDOW_CLOSE);
                };
        },
        44312: (e, t, o) => {
            "use strict";
            ...
            let h = (e) => {
                ...
                p = () => {
                    ...
                    (0, a.useEffect)(() => {
                        ...
                        return (
                            null == (e = window.desktopEvents) ||
                                e.on(n.EE.UPDATE_AVAILABLE, r),
                            () => {
                                var e;
                                null == (e = window.desktopEvents) ||
                                    e.off(n.EE.UPDATE_AVAILABLE, r);
                            }
                        );
                    }, [r]);
                };
            ...
            let l = () => {
                let [e, t] = (0, s.useState)(!1),
                    {
                        releaseNotes: {
                            ...
                            isReady: l,
                            modal: n,
                            setSortedDescReleaseNotesKeys: r,
                        },
                    } = (0, a.Pjs)(),
                    i = (0, s.useCallback)(
                        (e, s) => {
                            let {
                                needToShowReleaseNotes: a,
                                sortedDescReleaseNotesKeys: l,
                                translationsReleaseNotes: n,
                            } = s;
                            o(n), r(l), a && t(!0);
                        },
                        [r, o],
                ...
                (0, s.useEffect)(() => {
                    ...
                    (0, s.useEffect)(() => {
                        ...
                        return (
                            null == (e = window.desktopEvents) ||
                                e.on(a.EE.LOAD_RELEASE_NOTES, i),
                            () => {
                                var e;
                                null == (e = window.desktopEvents) ||
                                    e.off(a.EE.LOAD_RELEASE_NOTES, i);
                            }
                        );
                    }, [i]);
            };
        ...
        65892: (e, t, o) => {
            ...
            let d = (0, a.PA)((e) => {
                ...
                return (null == (t = r.browserInfo) ? void 0 : t.isTouch) &&
                    (!a.isAuthorized || d)
                    ? (0, s.jsx)("div", {
                          ref: c,
        ...
        76865: (e, t, o) => {
            ...
            let n = () => {
                ...
                (0, s.useEffect)(() => {
                    ...
                    return (
                        null == (e = window.desktopEvents) ||
                            e.on(l.EE.FIRST_LAUNCH, t),
                        () => {
                            var e;
                            null == (e = window.desktopEvents) ||
                                e.off(l.EE.FIRST_LAUNCH, t);
                        }
                    );
                }, [t]);
            };
            ...
            let A = C.gK.model("TranslationsModel", { data: C.gK.frozen() }),
                E = C.gK
                    .model("ReleaseNotes", {
                        ...
                        sortedDescReleaseNotesKeys: C.gK.maybeNull(
                            C.gK.array(C.gK.string),
                        ),
                    })
                    .views((e) => ({
                        get isReady() {
        ...
        85610: (e) => {
            e.exports = {
                ...
                offerButton_important:
                    "WelcomePage_offerButton_important__0wf60",
        ...
        87264: (e, t, o) => {
            ...
            let p = (0, a.PA)((e) => {
                    ...
                    let { isAuthorizedUser: p = !1 } = e,
                        ...
                        N = (0, n.useCallback)(() => {
                            ...
                            let t = new URLSearchParams({
                                    ...
                                    retpath: encodeURIComponent(
                                        "https://music.yandex.ru/settings?reqid=527383194170610471317084142111361467&from-passport",
                                    ),
                                }),
                                o =
                                    (null == g || null == (e = g.redirectButton)
                                        ? void 0
                                        : e.link) ||
                                    A.getAuthorizationUrlWithParams(t);
                            o &&
                                window.open(o, "_blank", "noreferrer noopener");
                        }, [
                            A,
                            null == g || null == (o = g.redirectButton)
                                ? void 0
                                : o.link,
                        ]),
                        f =
                            (null == g || null == (a = g.redirectButton)
                                ? void 0
                                : a.text) ||
                            m({ id: "snegir.redirect-button-text" }),
                        k =
                            (null == g || null == (_ = g.authButton)
                                ? void 0
                                : _.text) ||
                            m({ id: "snegir.auth-button-text" }),
                        b = (0, n.useMemo)(
                            () =>
                                p
                                    ? (0, s.jsx)(i.Button, {
                        ...
                        j =
                            (null == g ? void 0 : g.mainText) ||
                            m({ id: "snegir.main-text" }, { br: "\r\n" });
                    return (0, s.jsxs)("div", {
                        className: h().root,
                        children: [
                ...
                m = (0, a.PA)((e) => {
                    let { children: t } = e,
                        ...
                        l =
                            o.checkExperiment(
                                u.zal.WebNextBlockFullscreen,
                                "on",
                            ) || !a.isServiceAvailable;
                    return ((0, u.QVD)(l), l)
                        ? a.isAuthorized
                            ? (0, s.jsx)(p, { isAuthorizedUser: !0 })
                            : (0, s.jsx)(p, {})
                        : t;
                });
        },
                        ...
                        e.tracksController &&
                            e.tracksController
                                ...
                                .then(() => {
                                    ...
                                    null == (e = window.desktopEvents) ||
                                        e.send(
                                            a.EE.TRACKS_AVAILABILITY_UPDATED,
                                        );
                                });
                    }, [e.tracksController]);
                (0, s.useEffect)(() => {
                    ...
                    return (
                        null == (e = window.desktopEvents) ||
                            e.on(a.EE.REFRESH_TRACKS_AVAILABILITY, t),
                        () => {
                            var e;
                            null == (e = window.desktopEvents) ||
                                e.off(a.EE.REFRESH_TRACKS_AVAILABILITY, t);
                        }
                    );
                }, [t]);
            };
                    ...
                    t = (0, s.useCallback)(() => {
                        e.tracksController &&
                            e.tracksController.refreshTracksMeta().then(() => {
                                var e;
                                null == (e = window.desktopEvents) ||
                                    e.send(a.EE.REPOSITORY_META_UPDATED);
                            });
                    }, [e.tracksController]);
                (0, s.useEffect)(() => {
                    var e;
                    return (
                        null == (e = window.desktopEvents) ||
                            e.on(a.EE.REFRESH_REPOSITORY_META, t),
                        () => {
                            var e;
                            null == (e = window.desktopEvents) ||
                                e.off(a.EE.REFRESH_REPOSITORY_META, t);
                        }
                    );
                }, [t]);
            };
        ...
        93736: (e, t, o) => {
            ...
            let s = {
                ...
                width: 750,
                blurDataURL:
                    "data:image/webp;base64,UklGRkQAAABXRUJQVlA4IDgAAADQAQCdASoFAAgAAkA4JQBOgCHh3c/IAAD+/eovkSS/bwVeZYW8gP0CqVSvDPwORMoGN02KRYOAAA==",
                blurWidth: 5,
                blurHeight: 8,
            };
        },
        98185: (e, t, o) => {
            ...
            let m = {
                    ...
                    li: (e) =>
                        (0, s.jsx)("li", { className: p().item, children: e }),
                    code: (e) =>
                        (0, s.jsx)("code", {
                            className: p().code,
                            children: e,
