    ...
    49041: function (e, t, n) {
      ...
      let f = (0, s.Pi)((e) => {
          let {
            ...
            w = C.get(p.xit),
            k = C.get(p.U5t),
            j = (0, p.yyu)(k.oldWebHost),
            E = (0, a.useMemo)(
              () =>
                g.layout === p.t8m.Mobile ? n(75266).Z.src : n(88103).Z.src,
              [g.layout],
            ),
            B = (0, a.useCallback)(() => {
          ...
          return (
            ...
            (0, o.jsxs)("div", {
              ...
              children: [
                ...
                S,
                O,
                (0, o.jsx)("img", { className: x().image, src: E }),
                b &&
                  (0, o.jsx)(_.Iw, {
                    className: x().user,
                    withMeta: g.layout !== p.t8m.Mobile,
                    variant: g.layout === p.t8m.Mobile ? "mobile" : "desktop",
        ...
        P = (0, s.Pi)((e) => {
          let { children: t } = e,
            { user: n, experiments: s } = (0, p.oR4)(),
            { isPassToProduct: i, isFreemium: r } = (0, p.NMB)();
          return n.isAuthorized
            ? s.checkExperiment(p.peG.WebNext, "on") && !n.isChild
              ? n.hasPlus || i || r
                ? t
    ...
    62688: function (e, t, n) {
      ...
      let m = (0, s.Pi)((e) => {
          ...
          let { isAuthorizedUser: n = !1 } = e,
            ...
            p = u.getExperiment(c.peG.WebNextBlockFullscreen),
            b =
              null == p
                ? void 0
            ...
            f = (0, r.useCallback)(() => {
              ...
              (null == b
                ? void 0
                : null === (e = b.redirectButton) || void 0 === e
                  ? void 0
                  : e.link) &&
                window.open(
                  null == b
                    ? void 0
                    : null === (t = b.redirectButton) || void 0 === t
                      ? void 0
                      : t.link,
                  "_blank",
                  "noreferrer noopener",
                  ...
                  (0, o.jsxs)("div", {
                    ...
                    children: [
                      (0, o.jsx)(l.Heading, {
                        ...
                        weight: "bold",
                        className: h().title,
                        children: null == b ? void 0 : b.mainText,
                      }),
                      P,
                    ],
                  }),
    ...
    78457: function (e, t, n) {
      ...
      let y = (0, s.Pi)((e) => {
          let {
            ...
            { user: b, sonataState: x } = (0, a.oR4)(),
            f = (0, a.XUT)(),
            P = x.entityMeta,
            C = x.contextType === j.Ak.Generative,
            g = b.isAuthorized && !C,
            N = (0, E.SB)(x.entityMeta),
            w = (0, E.KX)(x.entityMeta);
          return (
            (0, i.useEffect)(() => {
        ...
        S = (0, s.Pi)((e) => {
          ...
          let E = (0, i.useMemo)(() => (u ? (s ? y : k) : s ? g : P), [s, u]);
          return (0, o.jsx)(E, {
            className: h,
