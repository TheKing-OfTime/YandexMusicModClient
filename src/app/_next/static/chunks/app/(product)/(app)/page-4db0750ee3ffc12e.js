(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [2966],
    {
        2117: (e, n, r) => {
            ...
            function a(e) {
                var n = function (n) {
                    ...
                    return i(
                        "formatDate" === e
                            ? r.formatDateToParts(d, t)
                            : r.formatTimeToParts(d, t),
                    );
                };
        ...
        39959: (e, n, r) => {
            ...
            let T = (0, s.PA)(() => {
                let { isScrolling: e } = (0, t.useContext)(u.B9),
                    ...
                    { from: l } = (0, c.fyy)({
                        pageId: c._Q$.OWN_TRACKS,
                        blockId: c.UfI.TRACK_LIST,
                    }),
                    d = (0, c.PT7)(),
                    h = (0, c.brA)(),
            ...
            let N = (0, s.PA)(() =>
                            ...
                            children: [
                                ...
                                !r.isEmpty &&
                                    (0, o.jsx)(u.DM, {
                                        ...
                                        isPlaying: P,
                                        onClick: _,
                                        className: (0, i.$)(j().playButton, {
                                            [j().stickyPlayButton]: !s,
                                        }),
                                        ariaHidden: !e,
                                        tabIndex: e ? 0 : -1,
                                        children:
                ...
                A = (0, s.PA)(() => {
                    var e;
                    let n = (0, c.jRO)(),
                        { contentScrollRef: r, setContentScrollRef: s } = (0,
                        c.gKY)(),
                        ...
                        y = (0, c.wZZ)(),
                        x = (0, m.c)(() => {
                            n.tracksController && f.getData(n.tracksController);
                        });
                    (0, h.L)(x),
                        (0, t.useEffect)(() => {
                            f.isNeededToLoad && x();
                        ...
                        (0, c.Jzs)(f.isResolved);
                    let k = (0, t.useMemo)(
                        () => ({
                            Header: () => (0, o.jsx)(T, {}),
                            Footer: () =>
                                (0, o.jsx)(u.A, {
                                    children: (0, o.jsx)(u.wi, {
                                        className: g().footer,
                                    }),
                                }),
                        }),
                    ...
                    if (f.loadingState === c.GuX.REJECT)
                        return (0, o.jsx)(v.w, {});
                    if (f.isEmpty) return (0, o.jsx)(N, {});
                    let D = (null == (e = f.items) ? void 0 : e.length) || 10;
                    return (0, o.jsx)(c.nVz, {
                        pageId: c._Q$.DOWNLOADS_TRACKS,
                        children: (0, o.jsx)(P.hO, {
                            scrollElement: r,
                            children: (0, o.jsxs)("div", {
        ...
        47416: (e, n, r) => {
            "use strict";
            r.d(n, { b: () => a, L: () => o.useDownloadedTracks });
            var o = r(88075),
                i = r(41028),
                s = r(75305),
                t = r(44078),
            ...
            let a = i.gK
                .compose(
                    i.gK.model("DownloadedTracks", {
                        items: i.gK.maybeNull(i.gK.array(t.vj)),
                        tracks: i.gK.maybeNull(i.gK.frozen()),
                    }),
                    d.XT,
                )
                .views((e) => ({
        ...
        59222: (e, n, r) => {
            Promise.resolve().then(r.bind(r, 95567)),
                ...
                Promise.resolve().then(r.bind(r, 39959)),
                ...
                Promise.resolve().then(r.bind(r, 88075)),
            ...
            let l = [i.DT.IDLE, i.DT.DOWNLOADED],
                d = (e) => {
                    ...
                    (0, o.useEffect)(() => {
                        ...
                        return (
                            null == (n = r.store) ||
                                n.tracks.events.on(i.je.STATE_CHANGED, e),
                            null == (o = r.store) ||
                                o.tracks.events.on(i.je.ENTITY_CHANGED, d),
                            () => {
                                var n, o;
                                null == (n = r.store) ||
                                    n.tracks.events.off(i.je.STATE_CHANGED, e),
                                    null == (o = r.store) ||
                                        o.tracks.events.off(
                                            i.je.ENTITY_CHANGED,
                                            d,
                        ...
                        e,
                        d,
                        null == (n = r.store) ? void 0 : n.tracks.events,
                    ]);
                };
        },
    },
    (e) => {
        e.O(
            ...
            [
                ...
                4397, 952, 594, 9775, 1311, 7764, 6706, 2089, 2140, 996, 4236,
                6728, 3949, 9152, 9169, 8740, 9615, 3588, 2732, 1744, 4204,
                7747, 4078, 9718, 4760, 8747, 5765, 2898, 5897, 5936, 9902,
                5598, 7358,
            ],
            () => e((e.s = 59222)),
        ),
