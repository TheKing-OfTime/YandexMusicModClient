(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4897],
  {
    16318: function (t, e, a) {
      Promise.resolve().then(a.bind(a, 60255));
    },
    60255: function (t, e, a) {
      "use strict";
      a.r(e);
      var n = a(9753),
        i = a(74717),
      ...
      e.default = () => {
        ...
        return t || (0, i.notFound)(), (0, n.jsx)(r.rT, { metatagId: t });
      };
    },
    ...
    99654: function (t, e, a) {
      ...
      var n = a(9753),
        ...
        y = a.n(b);
      let E = (0, r.Pi)((t) => {
        let { artist: e, className: a, children: r, contentLinesCount: b } = t,
          { ref: E, intersectionPropertyId: x } = (0, N.Vf)(),
          G = (0, N.x5)(),
          ...
          { isPlaying: Q, togglePlay: K } = (0, N.qm)({
            playContextParams: {
              contextData: {
                type: c.Ak.Artist,
                meta: { id: Number(F) },
          ...
          H = (0, C.useArtistDisclaimer)({ artist: e, callback: z }),
          X = (0, C.useArtistDisclaimer)({ artist: e, callback: K }),
          Y = (0, l.useCallback)(
            (t) => {
              null == I || I(), W({ to: u.qU.ArtistScreen }), H(t);
            },
            [W, I, H],
          ),
          $ = (0, l.useCallback)(
        ...
        return (0, n.jsx)(m.m7, {
          ...
          srTitle: (0, n.jsx)(S.rU, { href: e.url, onClick: Y, children: Z }),
    ...
    5293: function (t, e, a) {
      ...
      let p = (t) => {
        ...
        v = (0, o.Pi)((t) => {
          ...
          (0, i.useEffect)(() => {
            (null == a ? void 0 : a.scrollTop) === 0 && S(!1);
    ...
    95946: function (t, e, a) {
      ...
      var s = a(42288),
        ...
        m = a(38360),
        p = a(58421);
      let v = s.V5.model("GenreAlbumsPage", {
          loadingState: s.V5.enumeration(Object.values(g.Gu)),
          pager: s.V5.maybeNull(p.Vn),
      ...
      var f = a(12090);
      let N = s.V5.model("GenrePlaylistsPage", {
          loadingState: s.V5.enumeration(Object.values(g.Gu)),
          pager: s.V5.maybeNull(p.Vn),
          alreadyRequestedPages: s.V5.map(s.V5.number),
          pendingPages: s.V5.map(s.V5.number),
          ...
          errorStatusCode: s.V5.maybeNull(s.V5.number),
          fullTitle: s.V5.maybeNull(s.V5.string),
          items: s.V5.array(s.V5.maybeNull(f.Cd)),
        })
          .views((t) => ({
            get isNotFound() {
              var e;
  ...
  function (t) {
    t.O(
      ...
      [
        ...
        3490, 1055, 1579, 154, 2171, 361, 1744,
      ],
      function () {
        return t((t.s = 16318));
      },
