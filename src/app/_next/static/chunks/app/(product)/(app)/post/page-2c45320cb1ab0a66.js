(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    ...
    99654: function (t, e, n) {
      ...
      let S = (0, r.Pi)((t) => {
        let { artist: e, className: n, children: r, contentLinesCount: N } = t,
          ...
          D = (0, g.SB)(e),
          R = (0, g.BV)(e),
          { id: z, name: V, coverUri: U, isLiked: M } = e,
          O = (0, h.s0)(e.url),
          Z = (0, h.s0)(e.url, !0),
          [q, J] = (0, s.useState)(!1),
          H = (0, s.useMemo)(() => {
          ...
          { isPlaying: X, togglePlay: K } = (0, h.qm)({
            playContextParams: {
              contextData: {
                type: d.Ak.Artist,
                meta: { id: Number(z) },
          ...
          Y = (0, b.useArtistDisclaimer)({ artist: e, callback: O }),
          Q = (0, b.useArtistDisclaimer)({ artist: e, callback: Z }),
          $ = (0, b.useArtistDisclaimer)({ artist: e, callback: K }),
          tt = (0, g.ik)(Q, Y),
          te = (0, s.useCallback)(
            (t) => {
              null == w || w(), F({ to: u.qU.ArtistScreen }), tt(t);
            },
            [w, F, tt],
          ),
          tn = (0, s.useCallback)(
        ...
        return (0, i.jsx)(_.m7, {
          ...
          srTitle: (0, i.jsx)(f.rU, { href: e.url, onClick: te, children: H }),
    ...
    54864: function (t, e, n) {
      ...
      let c = (0, o.Pi)((t) => {
        ...
        let {
          ...
          { settings: v, experiments: x, trailer: g } = (0, l.oR)(),
          h = (0, a.BV)(o),
          f = (0, a.SB)(o),
          b = "".concat(l.aU.ARTIST, "-").concat(null == o ? void 0 : o.id),
          C = v.layout === l.t8.Mobile,
          N =
            x.checkExperiment(l.pe.WebNextEntityTrailer, "on") &&
            true &&
    ...
    5293: function (t, e, n) {
      ...
      let p = (t) => {
        ...
        v = (0, l.Pi)((t) => {
          ...
          (0, o.useEffect)(() => {
            (n && (null == n ? void 0 : n.scrollTop) !== 0) || f(!1);
    ...
    18211: function (t, e, n) {
      ...
      let g = () =>
        (0, i.jsxs)("div", {
          className: x().root,
          children: [
            (0, i.jsx)(u.Shimmer, { radius: "l", className: x().top }),
            (0, i.jsx)(u.Shimmer, { radius: "l", className: x().bottom }),
          ],
        });
      var h = n(90978),
        f = n.n(h),
  ...
  function (t) {
    t.O(
      0,
      [
        8609, 8670, 953, 6088, 899, 2498, 7873, 8695, 3621, 3394, 7868, 4901,
