(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [5439],
  {
    49894: function (e, t, n) {
      Promise.resolve().then(n.bind(n, 96622)),
        ...
        Promise.resolve().then(n.bind(n, 87273)),
        ...
        Promise.resolve().then(n.bind(n, 63778));
    },
    17295: function (e, t, n) {
      ...
      (() => {
        ...
        let e = (function e(t) {
          ...
          var i = (s[t] = { exports: {} });
          return o[t](i, i.exports, e), i.exports;
        })(810);
        a.useToggle = (t) => {
        ...
        getAverageFrequencies(e) {
          ...
          for (let e = s; e <= a; e++)
            (l +=
              ...
              d++;
          return (0, r.normalizeFrequency)(l / d);
        }
        constructor(e) {
      ...
      class c {
        ...
        constructor(e, t, n) {
          i._(this, "analyzer", void 0),
            ...
            (this.uniforms = new u.Uniforms((0, o.normalizeCollectionHue)(n))),
        ...
        update(e, t) {
          if (
            ...
            let n = t.getAverageFrequencies({ low: 0, high: 250 }),
              ...
              r = t.getAverageFrequencies({ low: 2e3, high: 4e3 });
    ...
    53367: function (e, t, n) {
      ...
      Object.defineProperty(t, "WZ", {
        enumerable: !0,
        get: function () {
          return r.FrequencyAnalyzer;
        },
      }),
        Object.defineProperty(t, "Qz", {
          enumerable: !0,
          get: function () {
            return r.DumbAnalyzer;
          },
        });
      var o = n(19434);
      ...
      Object.defineProperty(t, "UE", {
        enumerable: !0,
        get: function () {
          return a.DEFAULT_COLLECTION_SATURATION;
        },
      }),
        Object.defineProperty(t, "TP", {
          enumerable: !0,
          get: function () {
            return a.DEFAULT_COLLECTION_LIGHTNESS;
          },
        });
    },
    52999: function (e, t) {
    ...
    66975: function (e, t, n) {
      ...
      var i = n(98639),
        ...
        o = n(63394);
      let s = (e) => {
        let { artist: t, callback: n, shouldHistoryBack: s } = e,
          {
            disclaimer: a,
            modals: { disclaimerModal: l },
          } = (0, o.oR)(),
          d = (0, i.useRef)(String((0, r.Z)())),
          u = (0, i.useRef)(!1),
          c = (0, o.uK)().get(o.ce);
        return (
          (0, i.useEffect)(() => {
          ...
          (0, i.useCallback)(
            async (e) => {
              let i = c.get(o.BU.ExEx);
              if (
                (null == t ? void 0 : t.isUnsafeLegal) &&
                (null == i
                  ? void 0
                  : i.includes("".concat(o.co.ARTIST, "_").concat(t.id)))
              ) {
                null == n || n();
                return;
              }
              if (
                ...
                null == e || e.preventDefault(),
                  ...
                  t.isUnsafeLegal && a.setType(o.Gq.UNSAFE),
                  a.setId(d.current),
                  a.setEntityId(t.id),
                  a.setEntityType(o.co.ARTIST),
    ...
    99654: function (e, t, n) {
      ...
      var i = n(9753),
        ...
        T = n.n(y);
      let S = (0, o.Pi)((e) => {
        let { artist: t, className: n, children: o, contentLinesCount: y } = e,
          { ref: S, intersectionPropertyId: A } = (0, _.Vf)(),
          C = (0, _.x5)(),
          { formatMessage: E } = (0, a.Z)(),
          [R, L] = (0, s.useState)(!1),
          [k, I] = (0, s.useState)(!1),
          [w, O] = (0, s.useState)(!1),
          {
          ...
          V = (0, p.SB)(t),
          j = (0, p.BV)(t),
          { id: U, name: D, coverUri: F, isLiked: H } = t,
          G = (0, _.s0)(t.url),
          W = (0, _.s0)(t.url, !0),
          [q, Y] = (0, s.useState)(!1),
          K = (0, s.useMemo)(() => {
            let e = E({ id: "entity-names.artist-name" }, { artistName: D }),
              t = H ? E({ id: "entity-names.has-your-like" }) : "";
            return "".concat(e, " ").concat(t);
          }, [D, H, E]),
          { isPlaying: X, togglePlay: Z } = (0, _.qm)({
            playContextParams: {
              contextData: {
                type: c.Ak.Artist,
                meta: { id: Number(U) },
          ...
          J = (0, g.useArtistDisclaimer)({ artist: t, callback: G }),
          Q = (0, g.useArtistDisclaimer)({ artist: t, callback: W }),
          $ = (0, g.useArtistDisclaimer)({ artist: t, callback: Z }),
          ee = (0, p.ik)(Q, J),
          et = (0, s.useCallback)(
            (e) => {
              null == z || z(), B({ to: d.qU.ArtistScreen }), ee(e);
            },
            [z, B, ee],
          ),
          en = (0, s.useCallback)(
          ...
          ea = (0, s.useMemo)(
            () =>
              (0, i.jsx)(P.ArtistContextMenu, {
                artist: t,
                onOpenChange: es,
                open: w,
                returnFocus: !1,
                reference: (0, i.jsx)(h.z, {
                  onClick: eo,
                  className: (0, r.W)(T().menuButton, T().control),
                  "aria-label": E({ id: "interface-actions.context-menu" }),
                  icon: (0, i.jsx)(m.J, { size: "xxs", variant: "more" }),
                  size: "s",
                  radius: "round",
          ...
          el = (0, s.useMemo)(() => {
            if (t.isAvailable)
              return (0, i.jsx)(v.kk, {
                ...
                menuControl: ea,
                pinControl: (0, i.jsx)(x.RT, {
                  onClick: j,
                  isPinned: t.isPinned,
                  className: (0, r.W)(T().pinButton, T().control),
                  withRipple: !1,
                }),
              });
          }, [
          ...
          ed = (0, s.useMemo)(
            ...
            [en, F, K, t.isAvailable, el],
          );
        return (0, i.jsx)(v.m7, {
          ref: S,
          className: (0, r.W)(T().root, n),
          textPosition: "center",
          "aria-label": K,
          title: (0, i.jsx)(f.Caption, {
            variant: "div",
            type: "entity",
            size: "s",
            weight: "medium",
            lineClamp: 2,
            children: (0, i.jsx)(x.rU, {
          ...
          srTitle: (0, i.jsx)(x.rU, { href: t.url, onClick: et, children: K }),
          "data-intersection-property-id": A,
          description: (0, i.jsx)(f.Caption, {
            variant: "div",
            type: "entity",
            size: "s",
            weight: "medium",
    ...
    54864: function (e, t, n) {
      ...
      let u = (0, r.Pi)((e) => {
        ...
        let {
          ...
          { settings: b, experiments: f, trailer: p } = (0, l.oR)(),
          _ = (0, a.BV)(r),
          x = (0, a.SB)(r),
          g = "".concat(l.aU.ARTIST, "-").concat(null == r ? void 0 : r.id),
          P = b.layout === l.t8.Mobile,
          y =
            f.checkExperiment(l.pe.WebNextEntityTrailer, "on") &&
            true &&
            (null == r ? void 0 : r.hasTrailer),
          { href: T } = (0, l.qK)(
            null !== (t = null == r ? void 0 : r.url) && void 0 !== t ? t : "",
          ),
          { isPlaying: S, togglePlay: A } = (0, l.Qh)({
            seeds:
              null !== (n = null == r ? void 0 : r.seeds) && void 0 !== n
                ? n
                : [],
          ...
          E = (0, o.useCallback)(() => {
            (null == r ? void 0 : r.id) &&
              p.openArtistTrailer(null == r ? void 0 : r.id);
          ...
          (0, i.jsxs)(s.v2, {
            ...
            children: [
              !P &&
                (0, i.jsx)(d.Zd, {
                  onClick: _,
                  isPinned: null == r ? void 0 : r.isPinned,
                }),
              (0, i.jsx)(d.xZ, {
                onClick: x,
                isLiked: null == r ? void 0 : r.isLiked,
                disabled: !(null == r ? void 0 : r.isAvailable),
              }),
              y && (0, i.jsx)(d.NB, { onClick: E }),
              (0, i.jsx)(d.GQ, {
                onClick: C,
                disabled: !(null == r ? void 0 : r.isAvailable),
                variant: "artist",
              ...
              (0, i.jsx)(d.zq, {
                ...
                entityTitle: null == r ? void 0 : r.name,
              }),
            ],
          })
        );
    ...
    5293: function (e, t, n) {
      ...
      let a = (e) => {
        let { children: t, title: n, className: o } = e,
          { setTitleElement: a, setTitle: l } = (0, r.useContext)(s.pI),
          d = (0, r.useRef)(null);
        return (
          (0, r.useEffect)(() => {
            (null == d ? void 0 : d.current) && a(d), n && l(n);
          }, [d, n, a, l]),
          (0, r.useEffect)(
            () => () => {
              l("");
          ...
          (0, i.jsx)("div", { ref: d, className: o, children: t })
        );
      };
      var l = n(9544),
        d = {
      ...
      let m = (e) => {
          ...
          return n + (i ? 56 : 72) >= t.offsetTop + r;
        },
        b = (0, l.Pi)((e) => {
          let {
              children: t,
            ...
            [d, u] = (0, r.useState)(o),
            [c, b] = (0, r.useState)(null),
            [f, p] = (0, r.useState)(!1),
            [_, x] = (0, r.useState)(!1),
            { settings: g } = (0, v.oR)(),
            P = g.layout === v.t8.Mobile;
          (0, r.useLayoutEffect)(() => {
            u(o);
          }, [o]);
          ...
          (0, r.useEffect)(() => {
            (n && (null == n ? void 0 : n.scrollTop) !== 0) || x(!1);
          ...
          return (0, i.jsx)(s.pI.Provider, { value: T, children: t });
        });
      n(66414);
      let f = () => {
    ...
    54050: function (e, t, n) {
      ...
      let v = (e) => {
        ...
        let [r, o] = (0, i.useState)({}),
          { sonataState: s } = (0, h.oR)();
        (0, i.useEffect)(() => {
          if (s.contextType === l.Ak.Vibe) {
            var t, n, i, a;
            r.id ===
      ...
      let f = "vibe-animation",
        p = (0, s.Pi)((e) => {
          ...
          let { className: g } = e,
            ...
            y = (0, i.useRef)(null),
            { isIntersecting: T } =
              null !== (x = (0, d.S1)([P])[f]) && void 0 !== x ? x : {},
            { sonataState: S, user: A } = (0, h.oR)(),
            { theme: C } = (0, h.Fg)(),
            E = (0, i.useContext)(r),
            R = S.status === u.Xz.PLAYING && S.contextType === l.Ak.Vibe;
          return (
            (0, i.useEffect)(() => {
              if (P.current && E) {
                var e, t;
                let n =
                    null === (t = S.entityMeta) || void 0 === t
                      ...
                      : null === (e = t.trackParameters) || void 0 === e
                        ...
                        : e.hue,
                  i = A.collectionHue;
                (y.current = new c.dr(P.current, E, i)),
                  y.current.applySettings({ hue: n, collectionHue: i }),
                  P.current.classList.add(b().root_visible);
              }
              return () => {
                var e;
            ...
            (0, i.useEffect)(() => {
                ...
                u =
                  null === (o = S.entityMeta) || void 0 === o
                    ...
                    : null === (r = o.trackParameters) || void 0 === r
                      ? void 0
                      : r.userCollectionHue;
              u && A.setUserCollectionHue(u),
                R
                  ? null === (s = y.current) ||
                    void 0 === s ||
                    s.playAnimation({ hue: l, collectionHue: u, energy: d })
                  : null === (a = y.current) ||
                    void 0 === a ||
                    a.idleAnimation();
            }, [
              ...
              null === (m = S.entityMeta) || void 0 === m
                ? void 0
                : null === (s = m.trackParameters) || void 0 === s
                  ? void 0
                  : s.energy,
              null === (_ = S.entityMeta) || void 0 === _
                ? void 0
                : null === (p = _.trackParameters) || void 0 === p
                  ? void 0
                  : p.userCollectionHue,
            ]),
            (0, i.useEffect)(() => {
              var e;
              let t = C === h.Q2.Dark ? 0.0705 : 0.9607;
              null === (e = y.current) ||
                void 0 === e ||
    ...
    18723: function (e, t, n) {
      ...
      let b = (0, o.Pi)((e) => {
        let { className: t, withBackwardControl: n = !0 } = e,
          ...
          { contentRef: v } = (0, h.$Y)();
        return (0, i.jsxs)("div", {
          className: (0, r.W)(m().root, t),
          children: [
            n &&
              (0, i.jsx)(c.n, {
                withBackwardFallback: "/",
                className: (0, r.W)(m().navigation, {
                  [m().navigation_desktop]: !v,
                }),
                withForwardControl: !1,
              }),
            (0, i.jsxs)("div", {
              className: (0, r.W)(m().content, { [m().content_shrink]: !n }),
              children: [
                (0, i.jsx)(d.J, {
                  className: m().icon,
                  variant: "attention",
                ...
                (0, i.jsx)(u.Heading, {
                  className: (0, r.W)(m().title, m().important),
                  variant: "h3",
                  size: "xs",
                ...
                (0, i.jsxs)(u.Caption, {
                  className: (0, r.W)(m().text, m().important),
                  variant: "span",
                  type: "text",
                  size: "l",
                  weight: "normal",
  ...
  function (e) {
    e.O(
      0,
      [
        8609, 8670, 899, 1118, 4585, 991, 953, 2903, 3813, 2498, 7873, 8695,
        3621, 3110, 3394, 7868, 4901, 3490, 1579, 1055, 9352, 8892, 6351, 7515,
        8101, 2171, 361, 1744,
      ],
      function () {
        return e((e.s = 49894));
