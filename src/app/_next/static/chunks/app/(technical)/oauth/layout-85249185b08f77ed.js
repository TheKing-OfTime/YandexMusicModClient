(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [6808],
    {
        ...
        38467: (e, s, o) => {
            ...
            let t = () => {
                    var e;
                    null == (e = window.desktopEvents) ||
                        e.send(n.EE.WINDOW_MINIMIZE);
                },
                r = () => {
                    var e;
                    null == (e = window.desktopEvents) ||
                        e.send(n.EE.WINDOW_MAXIMIZE);
                },
                i = () => {
                    var e;
                    null == (e = window.desktopEvents) ||
                        e.send(n.EE.WINDOW_CLOSE);
                };
        },
        41121: (e, s, o) => {
            "use strict";
        ...
        77575: (e, s, o) => {
            ...
            let r = (e) => {
                ...
                sendDownloadTrack = (trackId) => {
                    ...
                    null === (s = window.desktopEvents) ||
                    void 0 === s ||
                    s.send(t.EE.DOWNLOAD_TRACK, trackId);
                },
    ...
    (e) => {
        e.O(
            0,
            [
                7098, 8282, 9712, 5271, 6071, 7309, 8712, 2866, 9765, 6451,
                8004, 9284, 7509, 1709, 4397, 2621, 952, 9775, 9323, 9814, 9149,
                8065, 594, 7313, 1020, 8400, 8387, 9750, 7245, 5952, 1917, 1311,
                7764, 6706, 2089, 2140, 996, 4236, 6728, 7508, 9152, 5675, 9837,
                9169, 8740, 9615, 3588, 2732, 1744, 4204, 7747, 4078, 9718,
                4760, 8747, 5765, 2898, 508, 3984, 3477, 7111, 5897, 3663, 939,
                5958, 682, 3761, 7443, 2561, 5971, 8096, 7410, 5613, 5767, 4691,
                6659, 5936, 8941, 1799, 9902, 5598, 7358,
            ],
            () => e((e.s = 77864)),
        ),
            (_N_E = e.O());
