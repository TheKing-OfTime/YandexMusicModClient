(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
      ...
      let i = [
          ...
          [
            ...
            (e) => {
              ...
              n.set(r.wxR.DEEPLINK, r.Kj$.PLAY_VIBE);
              let o = new URLSearchParams(window.location.search),
                t = (0, r.CXc)(o, n);
              return "landing" === n.get(r.wxR.SCREEN)
                ? "/?".concat(t.toString())
          ...
          let { formatMessage: e } = (0, r.Z)(),
            ...
            l = (0, s.useCallback)(
              (s, r) => {
                o.current !== r &&
                  ((o.current = r),
                  n((0, t.jsx)(c, { formatMessage: e, version: r }), {
      ...
      let l = (e) => {
        ...
        (0, t.useEffect)(() => {
          ...
          let s =
            ...
            onEntityChange =
              n?.state.queueState.currentEntity.onChange((n) => {
                e && sendPlayerStatePlaying(n);
              }),
            seekTracker =
              n?.state.playerState.event.onChange((e) => {
                if (
                  n.state.playerState.event.value === r.xg.SET_PROGRESS
                ) {
                ...
                : n.state.currentContext.onChange(() => {
                    ...
                    null == e || e(),
                      ...
                      (t =
                        null == n
                          ? void 0
                          : null === (r = n.state.currentContext.value) ||
                              void 0 === r
                            ? void 0
                ...
                children: [
                  ...
                  (0, t.jsx)(l.Button, {
                    ...
                    children: (0, t.jsx)(a.Caption, {
                      ...
                      variant: "span",
                      size: "m",
                      children: (0, t.jsx)(i.Z, { id: "navigation.page-main" }),
                    }),
                  }),
                ],
              }),
  ...
  function (e) {
    e.O(
      0,
      [
        9876, 5970, 8580, 3806, 4665, 8115, 5470, 8401, 7645, 296, 9125, 4679,
        5684, 861, 3661, 5638, 9983, 8667, 3380, 3313, 1729, 9779, 2613, 2532,
        583, 909, 7138, 5453, 7873, 8015, 9282, 7255, 317, 585, 1084, 7408,
        7141, 1512, 2783, 2399, 7294, 7099, 1150, 2242, 8743, 8492, 495, 1562,
        9088, 7660, 7629, 8737, 4990, 4359, 8210, 9350, 3181, 12, 5660, 2159,
        3718, 8913, 9630, 1317, 2333, 4954, 6454, 3529, 6008, 7058, 6158, 1744,
      ],
      function () {
        return e((e.s = 45640));
      },
