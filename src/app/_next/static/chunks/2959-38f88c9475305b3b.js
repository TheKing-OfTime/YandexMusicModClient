  ...
  [2959],
  {
    2959: function (e, r, t) {
      ...
      let i = (e) => ({
        ...
        l = a.V5.model("Account", {
          loadingState: a.V5.enumeration(Object.values(o.Gu)),
          uid: a.V5.maybe(a.V5.number),
          hasPlus: a.V5.maybe(a.V5.boolean),
          login: a.V5.maybe(a.V5.string),
          avatarId: a.V5.maybe(a.V5.string),
          isChild: a.V5.maybe(a.V5.boolean),
          publicId: a.V5.maybe(a.V5.string),
          publicName: a.V5.maybe(a.V5.string),
        }),
        c = a.V5.model("Settings", {
          loadingState: a.V5.enumeration(Object.values(o.Gu)),
          showWizard: a.V5.boolean,
        ...
        f = a.V5.model("User", {
          ...
          .views((e) => ({
            ...
            get hasPlus() {
              return !!e.account.hasPlus;
            },
            get isChild() {
              return !!e.account.isChild;
            },
            get puid() {
              return e.account.uid;
            },
          ...
          .actions((e) => ({
            getAbout: (0, a.ls)(function* () {
              let { accountResource: r, modelActionsLogger: t } = (0, a.dU)(e);
              if (e.account.loadingState !== o.Gu.PENDING)
                try {
                  e.account.loadingState = o.Gu.PENDING;
                  let t = yield r.about();
                  (e.account = i(t)), (e.account.loadingState = o.Gu.RESOLVE);
                } catch (r) {
                  t.error(r), (e.account.loadingState = o.Gu.REJECT);
                }
            }),
            getSettings: (0, a.ls)(function* () {
              let { accountResource: r, modelActionsLogger: t } = (0, a.dU)(e);
              if (e.settings.loadingState !== o.Gu.PENDING)
                try {
                  e.settings.loadingState = o.Gu.PENDING;
                  let t = yield r.settings();
                  e.settings = s(t);
                } catch (r) {
                  t.error(r),
                    (e.settings.showWizard = !1),
                    (e.settings.loadingState = o.Gu.REJECT);
                }
            }),
            setUnauthorized: () => {
              e.account.loadingState = o.Gu.RESOLVE;
            },
            setUserCollectionHue: (r) => {
              e.userCollectionHue = r;
            },
          }));
      var u = t(9753),
        d = t(72344),
        ...
        k = {
          ...
          1739: (e, r, t) => {
            ...
            e.exports = n.forwardRef(function (e, r) {
              return n.createElement("svg", Object.assign({}, e, { ref: r }), [
                n.createElement("use", { key: "queue", xlinkHref: "#queue" }),
              ]);
            });
          },
          7692: (e, r, t) => {
          ...
          5151: function (e, r, t) {
            ...
            r.iconsCollection = {
              ...
              arrowDown: l.default,
              arrowLeft: c.default,
              arrowRight: f.default,
              artist: u.default,
              attention: d.default,
              bookmateBadge: p.default,
              bookmateLogo: x.default,
              bucket: m.default,
              cast: g.default,
              chain: v.default,
              chartDown: y.default,
              ...
              close: w.default,
              collapse: h.default,
              collections_selected: j.default,
              ...
              like: T.default,
              liked: B.default,
              likedVariant: W.default,
              likeVariant: A.default,
              link: Z.default,
              lock: G.default,
              lyrics: q.default,
              menuArrow: J.default,
              ...
              non_music: $.default,
              note: ee.default,
              pause_filled: er.default,
              pause: et.default,
              pauseVibe: en.default,
              pencil: ea.default,
              pin_filled: eo.default,
              pin: ei.default,
              play_filled: es.default,
              play: el.default,
              playlist: ec.default,
              playVibe: ef.default,
              plus: eu.default,
              plusOutlined: ed.default,
              podcasts: ep.default,
              previous: ex.default,
              queue: em.default,
              repeat_one: eg.default,
              repeat: ev.default,
              reset: ey.default,
              search: ek.default,
              search_selected: e_.default,
              settings: eE.default,
              share: eb.default,
              shuffle: ew.default,
              speed_1x: eh.default,
              speed_1_25x: ej.default,
              speed_1_5x: eR.default,
              speed_1_75x: eO.default,
              speed_2x: eH.default,
              syncLyrics: eP.default,
              trailer: eC.default,
              unavailable: eV.default,
              uncollapse: eU.default,
              unpin: eN.default,
              users: ez.default,
              vibe: eS.default,
              volume: eL.default,
              volumeOff: eD.default,
              yandexRu: eI.default,
              yandexEn: eM.default,
            };
          },
          ...
          1093: function (e, r, t) {
            ...
            r.PlusBadge = (e) => {
              ...
              return (0, a.jsxs)("div", {
                className: (0, o.clsx)(l.default.root, r),
                children: [
                  (0, a.jsx)(s.Icon, {
                    variant: "plus",
                    size: "xxs",
          ...
          7743: function (e, r, t) {
            ...
            Object.defineProperty(r, "__esModule", { value: !0 }),
              (r.Caption = r.CaptionComponent = void 0);
            let a = t(9541),
              o = t(5881),
              i = t(810),
              s = t(4721),
            ...
            function c(e) {
              ...
              return (0, a.jsx)(s.Typography, {
                ...
                className: (0, o.clsx)(
                  l.default.root,
                  l.default["root_".concat(n, "_").concat(i)],
            ...
            (r.CaptionComponent = c),
              (r.Caption = (0, i.forwardRef)((e, r) =>
          ...
          404: function (e, r, t) {
            ...
            Object.defineProperty(r, "__esModule", { value: !0 }),
              (r.Heading = r.HeadingComponent = void 0);
            let a = t(9541),
              o = t(5881),
              i = t(810),
              s = t(4721),
              l = n(t(8544));
            (r.HeadingComponent = (e) => {
              let {
                forwardRef: r,
                variant: t,
                weight: n = "bold",
              ...
              (r.Heading = (0, i.forwardRef)((e, t) =>
                (0, a.jsx)(r.HeadingComponent, { forwardRef: t, ...e }),
              ));
          },
          4721: function (e, r, t) {
            var n =
            ...
            Object.defineProperty(r, "__esModule", { value: !0 }),
              (r.Typography = r.TypographyComponent = void 0);
            let a = t(9541),
              o = t(5881),
              i = t(810),
              s = n(t(2524));
            ...
            (r.TypographyComponent = l),
              (r.Typography = (0, i.forwardRef)((e, r) =>
                (0, a.jsx)(l, { forwardRef: r, ...e }),
              ));
          },
          2582: (e, r, t) => {
            Object.defineProperty(r, "__esModule", { value: !0 }),
              (r.Heading = r.Caption = void 0);
            var n = t(7743);
            Object.defineProperty(r, "Caption", {
              enumerable: !0,
              get: function () {
                return n.Caption;
              },
            ...
            var a = t(404);
            Object.defineProperty(r, "Heading", {
              enumerable: !0,
              get: function () {
                return a.Heading;
              },
      ...
      function E(e) {
        ...
        var t = (_[e] = { exports: {} });
        return k[e].call(t.exports, t, t.exports, E), t.exports;
      }
      (E.d = (e, r) => {
        for (var t in r)
          E.o(r, t) &&
      ...
      let H = (0, x.Pi)((e) => {
        let {
          ...
          { user: s, location: l, experiments: c } = (0, o.oR)(),
          f = (0, o.oz)(),
          { theme: x, setTheme: g } = (0, o.Fg)(),
          k = (0, o.uK)(),
          _ = k.get(o.V0),
          { origin: E } = k.get(o.U5).passportCredentials,
          b = k.get(o.xi),
          R = (0, m.useRef)(null),
          [H, P] = (0, m.useState)(_.get(o.BU.Theme)),
          C = (0, o.s0)("/settings"),
          V = y.w8.yandex.langs,
          { language: U, setLanguage: N } = (0, o.ZS)(),
          z = c.checkExperiment(o.pe.WebNextSettingsPage, "on"),
          S = true,
          L = JSON.stringify({ entrypoint: "web_desktop" }),
          D = (0, m.useCallback)(
            (e) => {
              (0, o.kz)(e),
                _.set(o.BU.Theme, e, { expires: 180 }),
                e === o.rL ? g(f) : g(e),
                P(_.get(o.BU.Theme));
            },
            [f, g, _],
        ...
        (0, m.useEffect)(() => {
          S ||
            (_.set(o.BU.EnableChangingLanguage, "off"),
            _.remove(o.BU.SavedUserLanguage));
        }, [_, S]);
        let I = (0, m.useCallback)(
          (e) => {
            _.set(o.BU.EnableChangingLanguage, "on"), N(e);
          },
          [N, _],
        );
        (0, m.useEffect)(() => {
          R.current && (R.current.className = O().iframe);
        }, [R]);
        let M = (0, m.useCallback)(
          (e, r, t) => {
            "settings" === e && (null == t || t.onClose(), C());
          },
          [C],
        );
        return (0, u.jsx)("div", {
          className: (0, p.W)(O().root, r),
          children: s.isAuthorized
            ? (0, u.jsxs)(u.Fragment, {
                children: [
                  (0, u.jsx)(d.User, {
                    className: O().userId,
                    platform: "desktop" === t ? "desktop" : "touch",
                    userData: { plus: s.hasPlus, avatarId: s.account.avatarId },
                    theme: H || o.Q2.Dark,
                    colorScheme: x,
                    onThemeChange: D,
                    onLocaleChange: I,
                    project: "music",
                    queryParams: {
                      "music.locales": S ? V.join() : "",
                      l10n: U,
                      "music.showSettings": z ? "1" : "0",
                      "music.chatContext": L,
                      target: "_blank",
                      origin: E,
                    },
                    env: "prod",
                    avatarSize: "desktop" === t ? 34 : 26,
                    dialogClassName: (0, p.W)(
                      O().dialog,
                      O()["dialog_".concat(t)],
                    ),
                    retpath: l.href,
                    ...
                    (0, u.jsxs)("div", {
                      ...
                      children: [
                        (0, u.jsx)(h.Caption, {
                          ...
                          size: "m",
                          weight: "medium",
                          className: (0, p.W)(O().userName, i),
                          lineClamp: 1,
                          children: s.account.publicName || s.account.login,
                        }),
                        s.hasPlus &&
                          (0, u.jsx)(j.rU, {
                            href: "https://plus.yandex.".concat(l.tld, "/"),
                            target: "_blank",
                            className: O().plusLink,
                            children: (0, u.jsx)(w, {
    ...
    66680: function (e, r, t) {
      ...
      let n = {
        yandex: {
          ...
          regionLangs: {
            RU: {
              langs: ["ru", "en", "hy", "uz", "kk", "az"],
              defaultLang: "ru",
            },
            BY: {
              langs: ["ru", "kk", "en", "hy", "uz", "az"],
              defaultLang: "ru",
            },
            KZ: {
              langs: ["ru", "en", "hy", "uz", "kk", "az"],
