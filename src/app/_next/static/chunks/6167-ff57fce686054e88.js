(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6167],
  {
    ...
    44755: function (e, t, n) {
      ...
      let m = (0, l.Pi)(() => {
        ...
        f = (0, l.Pi)((e) => {
          let { children: t } = e,
            { user: n } = (0, d.oR4)();
          return n.isAuthorized ? t : (0, o.jsx)(m, {});
        });
    },
    49041: function (e, t, n) {
      ...
      let C = (0, l.Pi)((e) => {
          let {
            ...
            A = w.get(h.xit),
            N = w.get(h.U5t),
            k = (0, h.yyu)(N.oldWebHost),
            E = (0, s.useMemo)(
              () =>
                b.layout === h.t8m.Mobile ? n(75266).Z.src : n(88103).Z.src,
              [b.layout],
            ),
            P = (0, s.useCallback)(() => {
            ...
            (0, o.jsxs)("div", {
              ...
              children: [
                ...
                x &&
                  (0, o.jsx)(f.Iw, {
                    className: v().user,
                    withMeta: b.layout !== h.t8m.Mobile,
                    variant: b.layout === h.t8m.Mobile ? "mobile" : "desktop",
        ...
        g = (0, l.Pi)((e) => {
          let { children: t } = e,
            { user: n, experiments: l } = (0, h.oR4)(),
            { isPassToProduct: i, isFreemium: a } = (0, h.NMB)();
          return n.isAuthorized
            ? l.checkExperiment(h.peG.WebNext, "on") && !n.isChild
              ? n.hasPlus || i || a
                ? t
    ...
    62688: function (e, t, n) {
      ...
      let p = (0, l.Pi)((e) => {
          ...
          let { isAuthorizedUser: n = !1 } = e,
            l = (0, i.useRouter)(),
            { experiments: d, settings: p } = (0, c.oR4)(),
            m = (0, c.uK4)().get(c.xit),
            f = p.layout === c.t8m.Mobile,
            h = d.getExperiment(c.peG.WebNextBlockFullscreen),
            x =
              null == h
                ? void 0
                : null === (t = h.value) || void 0 === t
                  ...
                  : t.metadata,
            v = (0, a.useCallback)(() => {
              m.authorizationUrl && l.push(m.authorizationUrl);
            }, [m.authorizationUrl, l]),
            C = (0, a.useCallback)(() => {
              var e, t;
              (null == x
                ? void 0
        ...
        m = (0, l.Pi)((e) => {
          let { children: t } = e,
            { user: n, experiments: l } = (0, c.oR4)();
          return l.checkExperiment(c.peG.WebNextBlockFullscreen, "on")
            ? n.isAuthorized
    ...
    22899: function (e, t, n) {
      ...
      n.n(l)().default(
        async () =>
          Promise.all([n.e(5219), n.e(6977), n.e(9576)]).then(n.bind(n, 49576)),
        { ssr: !1 },
      );
    },
    78918: function (e, t, n) {
      ...
      n.d(t, {
        ...
        vs: function () {
          return m.useApplicationDeeplinks;
        },
        Er: function () {
      ...
      let a = () => {
        ...
        (0, o.useEffect)(() => {
          ...
          return (
            null === (e = window.desktopEvents) ||
              void 0 === e ||
              e.on(i.BOn.REFRESH_APPLICATION_DATA, r),
            () => {
              var e;
              null === (e = window.desktopEvents) ||
                void 0 === e ||
                e.off(i.BOn.REFRESH_APPLICATION_DATA, r);
            }
          );
        }, [r]);
      };
      ...
      let i = () => {
        ...
        (0, o.useEffect)(() => {
          ...
          return (
            null === (t = window.desktopEvents) ||
              void 0 === t ||
              t.on(l.BOn.SHOW_RELEASE_NOTES, e.open),
            () => {
              var t;
              null === (t = window.desktopEvents) ||
                void 0 === t ||
                t.off(l.BOn.SHOW_RELEASE_NOTES, e.open);
            }
          );
        }, [e.open]);
      };
    ...
    22485: function (e, t, n) {
      ...
      let f = {
          ul: (e) =>
            (0, o.jsx)("ul", { className: m().description, children: e }),
          li: (e) => (0, o.jsx)("li", { className: m().item, children: e }),
          code: (e) => (0, o.jsx)("code", { className: m().code, children: e }),
          date: (e) => (0, o.jsx)("span", { className: m().date, children: e }),
          p: (e) => (0, o.jsx)("p", { className: m().paragraph, children: e }),
          br: (0, o.jsx)("br", {}),
        },
        h = (0, i.Pi)((e) => {
          let { dictionary: t } = e,
          ...
          return (0, o.jsx)(u.u, {
            ...
            children: (0, o.jsx)(c.t, {
              className: (0, l.W)(m().scrollableContent, m().important),
              containerClassName: (0, l.W)(m().notes, m().important),
              children: p.map((e) =>
                (0, o.jsxs)(
                  "div",
                  {
                    ...
                    children: [
                      (0, o.jsx)(d.Heading, {
                        variant: "h4",
                        className: (0, l.W)(m().version, m().important),
                        children: (0, _.K7K)(e),
                      }),
                      (0, o.jsx)(r.Z, { id: e, values: f }),
                    ],
                  },
                  e,
                ),
