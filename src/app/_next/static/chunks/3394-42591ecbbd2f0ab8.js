  ...
  [3394],
  {
      ...
      let p = [n.R.HOME, n.R.LANDING, n.R.NON_MUSIC],
        y = () => {
          ...
          return (0, a.useCallback)(
            ...
            [C, R, e, v, r, I, E, _, P, S, x, T, b, k, w, A, t],
          );
        };
    },
      ...
      let p = [n.R.HOME, n.R.LANDING, n.R.NON_MUSIC],
        y = () => {
          ...
          return (0, a.useCallback)(
            ...
            [t, S, T, b, x, r, P, e, w, R, A, C, k, v, I, E, _],
          );
        };
    },
      ...
      let p = [n.R.HOME, n.R.LANDING, n.R.NON_MUSIC],
        y = () => {
          ...
          return (0, a.useCallback)(
            ...
            [e, v, r, I, E, _, P, S, x, T, b, C, R, k, w, A, t],
          );
        };
    },
    ...
    63394: function (e, t, r) {
      ...
      r.d(t, {
        ...
        Xe: function () {
          return eA.MediaConfigControllerContext;
        },
        W$: function () {
          return ed.W;
        },
        ...
        B1: function () {
          return ek.SearchFeedbackContext;
        },
        yx: function () {
          return eZ.y;
        },
        ...
        Sc: function () {
          return eA.useMediaConfigController;
        },
        sv: function () {
          return C.useMetrika;
        },
        ...
        Sf: function () {
          return tm.useNonMusicSubscribeText;
        },
        d$: function () {
          return eh.d;
        },
        qm: function () {
          return eO.usePlayableContext;
        },
        bA: function () {
          return eU.usePlayableTrailerContext;
        },
        Qh: function () {
          return eL.usePlayableVibeContext;
        },
        oz: function () {
          return ti.usePreferredColorScheme;
        },
        YS: function () {
          return ey;
        },
      ...
      W.register("/"),
        ...
        W.register("/playlist/:playlistUuid"),
      ...
      ((i = g || (g = {})).WebNext = "WebNext"),
        ...
        (i.WebNextNonMusicLanding = "WebNextNonMusicLanding"),
        ...
        (i.WebNextFreemiumFeatures = "WebNextFreemiumFeatures"),
      ...
      let ev = (e) => {
        ...
        return (
          ...
          e.checkExperiment(g.WebNextNonMusicLanding, "on") &&
            t.push({
              icon: "non_music",
      ...
      let eT = { utm_source: "desktop", utm_medium: "copy_link" },
        eb = (e) => {
      ...
      let eR = () => {
        let {
          ...
          blockPosition: a,
          position: i,
        } = (0, R.useContext)(ek.SearchFeedbackContext) || {};
      ...
      ((o = v || (v = {})).PLAYLIST = "playlist"),
        ...
        ((c = E || (E = {})).OK = "ok"),
        (c.ERROR = "error"),
        ((l = _ || (_ = {})).LIKED_ALBUMS = "liked"),
        (l.UPCOMING_ALBUMS = "upcoming"),
        ((u = P || (P = {})).CREATED = "created"),
        (u.LIKED = "liked"),
        ((d = x || (x = {})).REJECT = "REJECT"),
        (d.UNSAFE = "UNSAFE"),
        ((h = S || (S = {})).ALBUM = "album"),
      ...
      var eW = r(84053),
        eB = r.n(eW);
      let eq = "desktop-release-notes.",
        eV = (e) => {
          var t;
          return null !== (t = e.split(eq)[1]) && void 0 !== t ? t : "";
        },
        eY = (e) =>
          Object.keys(e)
            .filter((e) => e.startsWith(eq))
            .sort((e, t) => {
              var r, a;
              let i = null !== (r = eV(e)) && void 0 !== r ? r : "",
                s = null !== (a = eV(t)) && void 0 !== a ? a : "";
              return eB()(i, s);
            });
      var eK = r(5979),
        eG = r(90454);
      ...
      let eJ = {
        [eZ.y.TOGGLE_PLAY]: {},
        [eZ.y.TOGGLE_MUTE]: {},
        [eZ.y.INCREASE_VOLUME]: { repeatable: !0 },
        [eZ.y.DECREASE_VOLUME]: { repeatable: !0 },
        [eZ.y.LIKE]: {},
        [eZ.y.DISLIKE]: {},
        [eZ.y.MOVE_FORWARD]: { repeatable: !0 },
        [eZ.y.MOVE_BACKWARD]: { repeatable: !0 },
        [eZ.y.SLIDE_FORWARD]: { repeatable: !0 },
        [eZ.y.SLIDE_BACKWARD]: { repeatable: !0 },
        [eZ.y.TOGGLE_REPEAT]: {},
        [eZ.y.TOGGLE_SHUFFLE]: {},
      };
      class e$ {
      ...
      class e0 {
        ...
        listen() {
          window.addEventListener("keydown", (e) => {
            ...
            if (!a || !i || !(0, eG.Z)(i, new e$(e)) || eX(e, i)) return;
        ...
        constructor(e) {
          (0, M._)(this, "store", void 0),
            (0, M._)(this, "listeners", eJ),
            (this.store = e.getFlatStore()),
            this.listen();
        }
      }
      let e1 = {
        [eZ.y.TOGGLE_PLAY]: [new e$({ code: T.KEY_K })],
        [eZ.y.TOGGLE_MUTE]: [new e$({ code: T.KEY_M })],
        [eZ.y.INCREASE_VOLUME]: [new e$({ code: T.ARROW_UP })],
        [eZ.y.DECREASE_VOLUME]: [new e$({ code: T.ARROW_DOWN })],
        [eZ.y.LIKE]: [new e$({ code: T.KEY_F })],
        [eZ.y.DISLIKE]: [new e$({ code: T.KEY_D })],
        [eZ.y.MOVE_FORWARD]: [new e$({ code: T.KEY_N })],
        [eZ.y.MOVE_BACKWARD]: [new e$({ code: T.KEY_P })],
        [eZ.y.SLIDE_FORWARD]: [
          new e$({ code: T.ARROW_RIGHT }),
          new e$({ code: T.KEY_L }),
        ],
        [eZ.y.SLIDE_BACKWARD]: [
          new e$({ code: T.ARROW_LEFT }),
          new e$({ code: T.KEY_J }),
        ],
        [eZ.y.TOGGLE_REPEAT]: [new e$({ code: T.KEY_R })],
        [eZ.y.TOGGLE_SHUFFLE]: [new e$({ code: T.KEY_S })],
      };
      class e8 {
        getFlatStore() {
          let e = {};
      ...
      let e4 = {
        [eZ.y.TOGGLE_PLAY]: ["K"],
        [eZ.y.TOGGLE_MUTE]: ["M"],
        [eZ.y.INCREASE_VOLUME]: ["↑"],
        [eZ.y.DECREASE_VOLUME]: ["↓"],
        [eZ.y.LIKE]: ["F"],
        [eZ.y.DISLIKE]: ["D"],
        [eZ.y.MOVE_FORWARD]: ["N"],
        [eZ.y.MOVE_BACKWARD]: ["P"],
        [eZ.y.SLIDE_FORWARD]: ["→", "L"],
        [eZ.y.SLIDE_BACKWARD]: ["←", "J"],
        [eZ.y.TOGGLE_REPEAT]: ["R"],
        [eZ.y.TOGGLE_SHUFFLE]: ["S"],
      };
      r(97445), r(79285);
      let e6 = (e, t) => (t > 0 ? Math.floor(e / t) : 0),
        e7 = (e, t) => {
          let r = e6(e, 3600),
            a = e6(e - 3600 * r, 60),
            i = e - 3600 * r - 60 * a,
      ...
      var te = r(40119);
      let tt = "system",
        tr = { [te.Q.Dark]: "ym-dark-theme", [te.Q.Light]: "ym-light-theme" };
      var ta = r(76100),
        ti = r(695);
      let ts = (e) => {
          e &&
            (document.body.classList.remove(...Object.values(tr)),
            Object.values(te.Q).includes(e) &&
              document.body.classList.add(tr[e]));
        },
        tn = (e, t) => {
          switch (e) {
            case te.Q.Dark:
      ...
      let tc = (e) => ({
        ...
        th = (e) => e.features.nonMusic,
        tf = () => th((0, L.useContainer)().get(O.U5));
      var tm = r(54605);
    },
    ...
    52122: function (e, t, r) {
      ...
      ((A || (A = {})).ConcertScreen = "concert_screen"),
        ...
        (E.Radio = "radio"),
        (E.Unknown = "unknown"),
        ((_ = q || (q = {})).AlbumListScreen = "album_list_screen"),
    ...
    99287: function (e, t, r) {
      "use strict";
      var a, i, s, n, o, c, l, u, d, h, f, m, g, p, y, v, E, _, P, x, S, T, b;
      r.d(t, {
        rp: function () {
          return d;
        },
    ...
    69869: function (e, t, r) {
      ...
      ((_ = ea || (ea = {})).SHOW_AND_LOAD = "SHOW_AND_LOAD"),
        (_.LOAD_AND_SHOW = "LOAD_AND_SHOW"),
        ((P = ei || (ei = {})).PLAYLIST_LIKED_TAB = "liked_playlist_tab"),
      ...
      class b {
        ...
        pause() {
          return this.core.pause().catch((e) => {
            throw new S("Core pause error", { code: f.PAUSE, cause: T(e) });
          });
        }
        resume() {
