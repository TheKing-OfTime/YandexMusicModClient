            ...
            (h[437] = (function () {
                ...
                (function (r, e) {
                    ...
                    var r = {
                        ...
                        e = [
                            874, 1250, 1251, 1252, 1253, 1254, 1255, 1256, 1e4,
                        ],
                        h = [932, 936, 949, 950],
                        l = [65001],
                        n = {},
                        ...
                        (n[65001] = function t(r) {
                            ...
                            (c[65001] = function (t, r) {
                                ...
                                var e = t.length,
                                    ...
                                    c = "string" == typeof t;
                                4 * e > C &&
                                    ((C = 4 * e), (g = o.allocUnsafe(C)));
                                for (var f = 0; f < e; ++f)
                                    (h = c
                                        ? t.charCodeAt(f)
                                        : t[f].charCodeAt(0)) <= 127
                                        ? (g[n++] = h)
                                        : h <= 2047
                                          ? ((g[n++] = 192 + (h >> 6)),
                                            (g[n++] = 128 + (63 & h)))
